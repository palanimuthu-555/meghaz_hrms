function revenue_add(year){
        ...
        var row = '<tr>' +
            ...
            '<td class="text-right actionss">'+
              '<a class="btn btn-info btn-sm " onclick="save_revenue('+count+','+year+',this)" data-type ="revenue" data-id="" id="revenue_save" title="Add" data-toggle="tooltip"><i class="fa fa-check"></i></a>'+
               // '<a class="btn btn-success btn-sm edit" id="revenue_edit" title="Edit" data-toggle="tooltip"><i class="fa fa-pencil"></i></a>'+
               ' <a class="btn btn-danger btn-sm delete" id="revenue_delete" title="Delete" data-toggle="tooltip"><i class="fa fa-trash-o"></i></a>'+
               '</td>' +
        '</tr>';
...
//        $('#new_hidden_rows').val(count);
        ...
        var row = '<tr>' +
            ...
            '<td><strong></strong></td>' +
            '<td class="text-right actionss">'+
              '<a class="btn btn-info btn-sm " onclick="save_expense('+count+','+year+',this)" data-type ="expense" data-id="" id="expense_save" title="Add" data-toggle="tooltip"><i class="fa fa-check"></i></a>'+
...
//        $('#new_hidden_rows').val(count);
        ...
        var row = '<tr>' +
            ...
            '<td class="text-right actionss">'+
              '<a class="btn btn-info btn-sm " onclick="save_tax('+count+','+year+',this)" data-type ="tax" data-id="" id="tax_save" title="Add" data-toggle="tooltip"><i class="fa fa-check"></i></a>'+
               // '<a class="btn btn-success btn-sm edit" id="tax_edit" title="Edit" data-toggle="tooltip"><i class="fa fa-pencil"></i></a>'+
               ' <a class="btn btn-danger btn-sm delete" id="tax_delete" title="Delete" data-toggle="tooltip"><i class="fa fa-trash-o"></i></a>'+
               '</td>' +
        '</tr>';
