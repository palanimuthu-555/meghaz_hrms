...
//      $('#new_hidden_rows').val(count);
        ...
        var row = '<tr>' +
            ...
            '<td class="text-right actionss">'+
              '<a class="btn btn-info btn-sm " onclick="save_asset('+count+','+year+',this)" data-type ="asset" data-id="" id="asset_save" title="Add" data-toggle="tooltip"><i class="fa fa-check"></i></a>'+
               // '<a class="btn btn-success btn-sm edit" id="revenue_edit" title="Edit" data-toggle="tooltip"><i class="fa fa-pencil"></i></a>'+
               ' <a class="btn btn-danger btn-sm delete" id="asset_delete" title="Delete" data-toggle="tooltip"><i class="fa fa-trash-o"></i></a>'+
               '</td>' +
        '</tr>';
...
//        $('#new_hidden_rows').val(count);
        ...
        var row = '<tr>' +
            ...
            '<td><strong></strong></td>' +
            '<td class="text-right actionss">'+
              '<a class="btn btn-info btn-sm " onclick="save_liabilitie('+count+','+year+',this)" data-type ="liabilitie" data-id="" id="liabilitie_save" title="Add" data-toggle="tooltip"><i class="fa fa-check"></i></a>'+
               // '<a class="btn btn-success btn-sm edit" id="expense_edit" title="Edit" data-toggle="tooltip"><i class="fa fa-pencil"></i></a>'+
               ' <a class="btn btn-danger btn-sm delete" id="liabilitie_delete" title="Delete" data-toggle="tooltip"><i class="fa fa-trash-o"></i></a>'+
               '</td>' +
        '</tr>';
...
//        $('#new_hidden_rows').val(count);
        ...
        var row = '<tr>' +
            ...
            '<td><strong></strong></td>' +
            '<td class="text-right actionss">'+
              '<a class="btn btn-info btn-sm " onclick="save_shareholder('+count+','+year+',this)" data-type ="shareholder" data-id="" id="shareholder_save" title="Add" data-toggle="tooltip"><i class="fa fa-check"></i></a>'+
               // '<a class="btn btn-success btn-sm edit" id="expense_edit" title="Edit" data-toggle="tooltip"><i class="fa fa-pencil"></i></a>'+
               ' <a class="btn btn-danger btn-sm delete" id="shareholder_delete" title="Delete" data-toggle="tooltip"><i class="fa fa-trash-o"></i></a>'+
               '</td>' +
        '</tr>';
