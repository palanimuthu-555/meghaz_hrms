		 <div class="content container-fluid">
			...
			<button class="btn btn-primary" onclick="document.getElementById('pdf_employee').click()">PDF</button>
							...
							<?php }  ?>
								...
								<div class="row">
									...
									<div class="col-md-6 col-sm-12">
										...
										<div class="card panel-default">
										    <div class="card-header"><h4 class="m-b-0 m-r-5"><strong>Earnings</strong></h4></div>
										    <div class="card-body panel-body-earnings m-b-0">
											<table class="table">
											...
											<tbody>
												...
												<tr>
													...
													<td <?php if($i==1) { echo 'style="border:none;"'; } ?>><strong><?php echo ucwords(str_replace(array('addtion||','_'), ' ', $key));?></strong> <span class="float-right">$<?php echo $value; ?></span></td>
											...
											<div class="card-footer panel-footer-earnings">
											<table class="table">
											<tbody>
											<tr>

											<td style="border:none;"><strong>Total Earnings</strong> <span class="float-right"><strong>$<?php echo $earnings; ?></strong></span></td>
									...
									<div class="col-md-6 col-sm-12">
										...
										<div class="card panel-default">
										    <div class="card-header"><h4 class="m-b-0 m-r-5"><strong>Deductions</strong></h4></div>
										    <div class="card-body panel-body-deductions">
											<table class="table">
											...
											<tbody>
												...
												<tr>
													...
													<td <?php if($j==1) { echo 'style="border:none;"'; } ?>><strong><?php echo ucwords(str_replace(array('deduction||','_'), ' ', $keys));?></strong> <span class="float-right">$<?php echo $values; ?></span></td>
											...
											<div class="card-footer panel-footer-deductions">
											<table class="table">
											<tbody>
											<tr>

											<td style="border:none;"><strong>Total Deductions</strong> <span class="float-right"><strong>$<?php echo $deductions;?></strong></span></td>
								...
								<div class="row">
									<div class="col-md-12">
										...
										<label type="button" class="label-netsalary float-right"><strong>Net Salary : <span class="m-l-10">$<?php echo ($earnings - $deductions); ?></span></strong> <!-- (Fifty nine thousand six hundred and ninety eight only.) --></label>
