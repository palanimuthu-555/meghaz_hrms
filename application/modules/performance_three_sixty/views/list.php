<div class="content">
	<div class="row">
		...
		<div class="col-sm-4 col-9 text-right m-b-30">
				<a href="<?php echo base_url()?>performance_three_sixty/manager_performance" class="btn btn-primary rounded float-right New-Leave" ><i class="fa fa-plus"></i> <?='Manager Performance';?></a>			
		</div>
	<?php } ?>
	</div>
