					...
					<div class="row">
						<div class="col-sm-8">
							...
							<ul class="breadcrumb mb-2">
				                ...
				                <li class="breadcrumb-item active">360 Performance </li>
				            </ul>
						</div>
					</div>
				</div>
													...
													<td class="text-center">														
														<div class="dropdown">
															...
															<div class="dropdown-menu float-right">
																<a class="dropdown-item" href="<?=base_url()?>performance_three_sixty/three_sixty_status/<?php echo $performance_360['id'];?>/1/<?php echo $performance_360['user_id']; ?>">Approved</a>
																<a class="dropdown-item" href="<?=base_url()?>performance_three_sixty/three_sixty_status/<?php echo $performance_360['id'];?>/2/<?php echo $performance_360['user_id']; ?>">Rejected</a>
																<a class="dropdown-item" href="<?=base_url()?>performance_three_sixty/three_sixty_status/<?php echo $performance_360['id'];?>/0/<?php echo $performance_360['user_id']; ?>">Pending</a>
															</div>
														</div>
