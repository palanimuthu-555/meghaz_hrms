						...
						<div class="col-lg-4 col-xl-3">
							...
							<div class="card project-user">
								...
								<div class="card-body">
									...
									<!-- <h6 class="card-title m-b-20">Assigned Leader <a class="float-right btn btn-primary btn-xs" data-toggle="modal" data-target="#assign_leader"><i class="fa fa-plus"></i> Add</a></h6> -->
							...
							<div class="card project-user">
								...
								<div class="card-body">
									...
									<h6 class="card-title">Assigned users <a class="float-right btn btn-primary btn-xs" data-toggle="ajaxModal" href="<?=base_url()?>projects/team/<?=$p->project_id?>"><i class="fa fa-plus"></i> Add</a></h6>
