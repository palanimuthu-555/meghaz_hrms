		...
		<div class="col-lg-4">
			<div class="card">
				<div class="card-body">
					...
					<table class="table table-striped table-border">
						<tbody>
							...
							<tr>
								...
								<td class="text-right">
									<!-- <a href="#"> -->
										<img src="<?php echo User::avatar_url($t->added_by); ?>" class="rounded-circle thumb-sm" data-toggle="tooltip" data-title="<?=User::displayName($t->added_by); ?>" data-placement="bottom">
					...
					<p class="m-b-5">Progress <span class="text-<?=config_item('theme_color')?> float-right"><?=$t->task_progress?>%</span></p>
			...
			<div class="card uploaded-files m-t-3">
				<div class="card-body">
								...
								<ul class="files-action">
									<li class="dropdown">
										...
										<div class="dropdown-menu">
											<a  class="dropdown-item" href="<?=base_url()?>projects/tasks/file/edit/<?=$f->file_id?>/<?=$project_id?>" data-toggle="ajaxModal"><i class="fa fa-edit"></i> Edit</a>
											<a  class="dropdown-item" href="<?=base_url()?>projects/tasks/file/delete/<?=$f->file_id?>/<?=$project_id?>" data-toggle="ajaxModal"><i class="fa fa-trash-o"></i> Delete</a>
										</div>
									</li>
								</ul>
			...
			<div class="card-box m-t-3">
				<h6 class="card-title m-b-15">Assigned to</h6>
				<ul class="team-members">
					<?php if(!User::is_client()){ ?>
					<?php foreach (Project::task_team($t->t_id) as $u) { ?>
					<li>
						<a href="javascript:void(0);">
							<img src="<?php echo User::avatar_url($u->assigned_user); ?>" class="rounded-circle" data-toggle="tooltip" data-title="<?=User::displayName($u->assigned_user); ?>" data-placement="right">
						</a>
					</li>
					<?php } ?>
					<?php } ?>
					...
					<div class="col-lg-8">
						<div class="card">
                            <div class="card-body">
                                <div class="project-title">
                                    <h5 class="card-title m-b-20"><?=$t->task_name?></h5>
                                </div>
                                <div class="task-desc">
                        ...
                        <div class="card panel-white m-t-3">
							<div class="card-header">
								<h3 class="card-title"><?=lang('latest_comments')?></h3>
							</div>
							<div class="card-body">
							<ul class="list-group list-group-task">
								...
								<li class="list-group-item">
									<a class="thumb-sm float-left m-r-sm">
									<img src="<?php echo User::avatar_url($c->posted_by); ?>" class="rounded" data-toggle="tooltip" data-title="<?=User::displayName($c->posted_by); ?>"
                        ...
                        <div class="card panel-default m-t-3">
                            <?php $attributes = 'class="m-b-0"'; $attributesID = 'id="taskViewComment"'; echo form_open(base_url().'projects/tasks/comment',$attributes,$attributesID); ?>
                                ...
                                <div class="card-footer bg-white">
									<button class="btn btn-success float-right" id="task_view_comment"><?=lang('comment')?></button>
