...
<div class="content">
	<div class="row">
		...
		<div class="col-sm-7 col-9 text-right m-b-20">
			...
			<?=lang('view_archive')?></a>
			<?php endif; ?>            
			<div class="btn-group float-right m-r-10"> 
				...
				<div class="dropdown-menu"> 
					<a class="dropdown-item" href="<?=base_url()?>projects?view=active"><?=lang('active')?></a>
					<a class="dropdown-item" href="<?=base_url()?>projects?view=on_hold"><?=lang('on_hold')?></a>
					<a class="dropdown-item" href="<?=base_url()?>projects?view=done"><?=lang('done')?></a>
					<a class="dropdown-item" href="<?=base_url()?>projects"><?=lang('all_projects')?></a>   
				</div> 
			</div>
					...
					<td class="text-right">
						<div class="dropdown">
							...
							<div class="dropdown-menu float-right dropdown-menu-right">
									...
									<a class="dropdown-item" href="<?=base_url()?>projects/view/<?=$p->project_id?>"><?=lang('preview_project')?></a>
								
								<?php if (User::is_admin() || User::perm_allowed(User::get_id(),'edit_all_projects')){ ?>   
								
									<a class="dropdown-item" href="<?=base_url()?>projects/edit/<?=$p->project_id?>"><?=lang('edit_project')?></a>
								
								<?php if ($archive) : ?>
								<a class="dropdown-item" href="<?=base_url()?>projects/archive/<?=$p->project_id?>/0"><?=lang('move_to_active')?></a>
								<?php else: ?>
							
									<a class="dropdown-item" href="<?=base_url()?>projects/archive/<?=$p->project_id?>/1"><?=lang('archive_project')?></a>
								        
								<?php endif; ?>
								<?php } ?>  
								<?php if (User::is_admin() || User::perm_allowed(User::get_id(),'delete_projects')){ ?> 
								
									<a class="dropdown-item" href="<?=base_url()?>projects/delete/<?=$p->project_id?>" data-toggle="ajaxModal"><?=lang('delete_project')?></a>
