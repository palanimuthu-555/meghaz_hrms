	...
	<div class="modal-content">
		...
		if(count($timers) > 0){
			...
			<div class="form-group">
				...
				<a class="thumb-xs float-left m-r-sm">
                       

                            <img src="<?php echo User::avatar_url($t->user); ?>" class="rounded-circle" data-toggle="tooltip" data-title="<?=User::displayName($t->user)?>" data-placement="left" class="rounded"> </a>
