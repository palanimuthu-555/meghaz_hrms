		...
		<div class="col-md-12">
			...
			<?=$this->session->flashdata('form_error') ?>
				<div class="row">
					...
					<div class="col-md-6">
						<div class="form-group">
							<label><?=lang('project_title')?> <span class="text-danger">*</span><span id="check_project_name" style="display: none;color:red;">Project Already Exist!</span></label>
							<input type="text" class="form-control" placeholder="<?=lang('project_title')?>" name="project_title" value="<?=set_value('project_title')?>" id="project_name">
						</div>	
					</div>	
				</div>	
				...
				<div class="m-t-20 text-center submit-section">
					<button id="project_add_submit" class="btn btn-primary submit-btn"><i class="fa fa-plus"></i> <?=lang('create_project')?></button>
				</div>
			</form>
		</div>
	</div>
