...
<div class="content">
	...
	<div class="row">
		...
		<div class="col-sm-7 col-12 text-right m-b-20">
			...
			if (User::is_admin() || User::perm_allowed(User::get_id(),'add_projects') || User::login_role_name() == 'client' && config_item('client_create_project') == 'TRUE') { ?>
				...
				<a href="<?php echo base_url(); ?>projects/grid_view" class="grid-view btn btn-link "><i class="fa fa-th"></i></a>
					...
					<div class="row filter-row">
						<div class="col-lg-4 col-sm-6 col-12">  
							...
							<input type="text" class="form-control floating project_search" id="project_title" name="project_title">
						...
						<div class="col-lg-4 col-sm-6 col-12">  
							<div class="form-group form-focus">
								...
								<input type="text" class="form-control floating project_search"  id="client_name" name="client_name">
