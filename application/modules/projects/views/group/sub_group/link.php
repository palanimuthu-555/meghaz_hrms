    ...
    <div class="card-body">
      <div class="row">
        <div class="col-lg-7">
          <ul class="list-group no-radius">
            <li class="list-group-item">
              <span class="float-right"><?=$link->link_title?> </span><?=lang('link_title')?>
            </li>
            <li class="list-group-item">
                <span class="float-right"><a href="<?=$link->link_url?>" target="_blank"><?=$link->link_url?> </a> </span><?=lang('link_url')?>
            </li>
            <li class="list-group-item">
              <span class="float-right"><?php echo Project::by_id($link->project_id)->project_title; ?></span><?=lang('project')?>
            </li>
          </ul>
        </div>
        <!-- End details C1-->
        <div class="col-lg-5">
          <ul class="list-group no-radius">
            <li class="list-group-item">
              <span class="float-right"><?=$link->username?></span><?=lang('username')?>
            </li>
            <li class="list-group-item">
              <span class="float-right"><input id="link-password" class="discreet" type="password" value="<?=$link->password?>" /></span><?=lang('password')?>
            </li>
          </ul>
        </div>
      </div>
