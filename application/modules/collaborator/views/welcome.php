        ...
        <div class="content container-fluid">
            ...
            <div class="col-lg-5 d-flex">
              <div class="card flex-fill">
                <ul class="nav nav-tabs custom-nav-tab">
                  <li class="nav-item">
                    <a class="nav-link active " data-toggle="tab" href="#mark-attendance">Mark <small>Attendance</small></a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#attendance-overview">Attendance Overview</a>
                  </li>
                </ul>
                <div class="card-body p-0">
                  <div class="tab-content p-t-0">
                    <div id="mark-attendance" class="tab-pane fade show active">
                      <div class="card punch-status mb-0">
                              <div class="card-body">
                    ...
                    <div id="attendance-overview" class="tab-pane fade">
                      <div class="card att-statistics mb-0">
                          ...
                          <td class="text-right">
                            <div class="dropdown">
                              ...
                              <div class="dropdown-menu float-right">
								<a class="dropdown-item" href="<?php echo base_url()?>all_tasks/view/<?php echo $task['project']?>" title="Edit"><i class="fa fa-pencil m-r-5"></i> Edit</a>
								<a class="dropdown-item" href="#" title="Delete" data-toggle="modal" onclick="delete_task(<?php echo $task['t_id'];?>)"  ><i class="fa fa-trash-o m-r-5"></i> Delete</a>
                              </div>
                            </div>
                          </td>
                        </tr>
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="card panel-table">
                <div class="card-header">
                  <h3 class="card-title mb-0">Wiki</h3>
                </div>
                <div class="card-body">
                  <div class="table-responsive">
                    <?php 
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title mb-0">My Calender</h3>
                </div>
                <div class="card-body">
                  <div id="calendar"></div>
                </div>
