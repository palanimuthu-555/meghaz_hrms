          ...
          <img src="<?php echo User::avatar_url(User::get_id()); ?>" class="rounded-circle">
              ...
              placeholder="<?php echo Project::by_id($project_id)->project_title; ?> <?=lang('comment')?>" ></textarea>
                    ...
                    <footer class="card-footer bg-light lter">
                      <button class="btn btn-success float-right btn-sm" type="submit" id="project_comment_discussion">
...
<a class="float-left thumb-sm avatar">
  ...
  <img src="<?php echo User::avatar_url($reply->replied_by); ?>" class="rounded-circle">

</a>
<?php } else { echo lang('user_not_found'); } ?>

                          <span class="arrow left"></span>
                        <section class="comment-body card panel-default text-sm">
                          <div class="card-body">
                          <span class="text-muted m-l-sm float-right">
