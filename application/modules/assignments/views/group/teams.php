<div class="card panel-table">
	<div class="card-header panel-h-p1">
		<div class="row">
			<div class="col-6">
				<h3 class="card-title m-t-6">Team</h3>
			</div>
			<div class="col-6">
				<?php if(User::is_admin()){ ?>
				<a href="<?=base_url()?>projects/team/<?=$project_id?>" data-toggle="ajaxModal" class="btn btn-primary btn-sm float-right"><?=lang('update_team')?></a>
				<?php } ?>
			</div>
		</div>
	</div>
			...
			<table id="table-teams" class="table table-striped custom-table m-b-0 AppendDataTables">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<a class="thumb-sm avatar" href="javascript:void(0);"><img src="<?php echo User::avatar_url($u->assigned_user); ?>" class="rounded"></a>
						...
						?>
						<td>
							<span class=""><?=lang('time_spent')?></span> &raquo; <span class="badge badge-success"><?=$format?></span><br>
							<span class=""><?=lang('hourly_rate')?></span> &raquo; <span class="badge badge-default">
