<div class="card panel-table">
	<div class="card-header panel-h-p1">
		<div class="row">
			<div class="col-6">
				<h3 class="card-title m-t-6">Milestones</h3>
			</div>
			<div class="col-6">
				<?php  // if(User::is_admin() || Project::is_assigned(User::get_id(),$project_id)){ ?>
				<a href="<?=base_url()?>projects/milestones/add/<?=$project_id?>" data-toggle="ajaxModal" class="btn btn-primary btn-sm float-right"><?=lang('add_milestone')?></a> 
				<?php // } ?>
			</div>
		</div>
	</div>
