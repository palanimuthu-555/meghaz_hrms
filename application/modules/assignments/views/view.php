                ...
                <div class="content container-fluid">
					...
					<div class="row">
						...
						<div class="col-sm-6 col-5">
							...
							<ul class="breadcrumb">
				                ...
				                <li class="breadcrumb-item"><a href="<?=base_url()?>projects"><?=($archive ? lang('project_archive') : lang('projects'));?></a></li>
				                <li class="breadcrumb-item active"><?=$p->project_title; ?></li>
				            </ul>
						</div>

						<div class="col-sm-6 col-7 text-right m-b-30">
							<?php
					...
					$project_files =$this->db->query("SELECT tf.* FROM dgt_tasks AS t LEFT JOIN  dgt_task_files AS tf ON tf.task=t.t_id  WHERE t.project='".$p->project_id."' ORDER BY tf.date_posted ASC")->result_array();
											...
											<div class="card mb-1">
												<div class="card-body">
													<div class="uploaded-box">
														...
														<div class="uploaded-img mb-2">

															<img style="height: 70px; width: 100px;" class="img-fluid" src="<?php echo base_url().'assets/project-files/'.$project_file['path'].'/'.$project_file['file_name'];?>" class="img-fluid" alt="">
							...
							<div class="project-task">
								...
								<ul class="nav nav-tabs nav-tabs-bottom nav-justified m-b-0">
									<li class="nav-item"><a class="active nav-link" href="#all_tasks" data-toggle="tab" aria-expanded="true">All Tasks</a></li>
														...
														<li class="<?php echo $task_progrs; ?> task">
															...
															<div class="task-container">
																...
																<span class="task-action-btn task-check">
																	...
																	<span class="action-circle large complete-btn <?php echo ($task_progrs == 'completed')?'task_uncompletes':'task_completes'; ?>" data-id="<?php echo $task['t_id']; ?>" title="<?php echo ($task_progrs == 'completed')?'Mark Pending':'Mark Complete'; ?>">
													...
													<ul id="task-list">
													    ...
													    <?php foreach($open_tasks as $taskss){ 
													        ...
													        $assign_member = $this->db->select('*')
																	         ->from('assign_tasks PA')
																	         ->join('account_details AD','PA.assigned_user = AD.user_id')
																	         ->where('PA.task_assigned',$taskss['t_id'])
																	         ->get()->row_array(); 
														...
														<li class="<?php echo $task_progrss; ?> task">
															...
															<div class="task-container">
																...
																<span class="task-action-btn task-check">
																	...
																	<span class="action-circle large complete-btn <?php echo ($task_progrss == 'completed')?'task_uncompletes':'task_completes'; ?>" title="Mark Complete" data-id="<?php echo $taskss['t_id']; ?>">
													...
													<ul id="task-list">
													    ...
													    <?php foreach($completed_tasks as $tasss){ 
													        ...
													        $assign_member = $this->db->select('*')
																	         ->from('assign_tasks PA')
																	         ->join('account_details AD','PA.assigned_user = AD.user_id')
																	         ->where('PA.task_assigned',$tasss['t_id'])
																	         ->get()->row_array(); 
														...
														<li class="<?php echo $task_progr; ?> task">
															...
															<div class="task-container">
																...
																<span class="task-action-btn task-check">
																	...
																	<span class="action-circle large complete-btn <?php echo ($task_progr == 'completed')?'task_uncompletes':'task_completes'; ?>" title="Mark Pending" data-id="<?php echo $tasss['t_id']; ?>">
						...
						<div class="col-lg-4 col-xl-3">
							...
							<div class="card project-user">
								...
								<div class="card-body">
									...
									<!-- <h6 class="card-title m-b-20">Assigned Leader <a class="float-right btn btn-primary btn-sm" data-toggle="modal" data-target="#assign_leader"><i class="fa fa-plus"></i> Add</a></h6> -->
							...
							<div class="card project-user">
								...
								<div class="card-body">
									<h6 class="card-title">Assigned users <?php if(App::is_permit('menu_projects','write')){
									?><a class="float-right btn btn-primary btn-sm" data-toggle="ajaxModal" href="<?=base_url()?>projects/team/<?=$p->project_id?>"><i class="fa fa-plus"></i> Add</a><?php }?></h6>
									...
									<ul class="list-box">
										...
										<li>
											...
											<a href="<?php if(App::is_permit('menu_users','read')){?><?php echo base_url(); ?>employees/profile_view/<?php echo $member_details['user_id']; ?><?php }else{ echo '#';}?>">
