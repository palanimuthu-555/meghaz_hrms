<div class="header-fixed clearfix hidden-print p-0">
	<div class="row m-t-8">
		...
		<div class="col-sm-4 float-right">
			...
			<a href="<?=base_url()?>fopdf/estimate/<?=$e->est_id?>" class="btn btn-sm btn-primary float-right m-r-5"><i class="fa fa-file-pdf-o"></i> <?=lang('pdf')?></a>
			<?php elseif(config_item('pdf_engine') == 'mpdf') : ?>
			<a href="<?=base_url()?>estimates/pdf/<?=$e->est_id?>" class="btn btn-sm btn-primary float-right m-r-5"><i class="fa fa-file-pdf-o"></i> <?=lang('pdf')?></a>
			<?php endif; ?>
			<?php } ?>
		</div>
	</div>
