                ...
                <?php if(!User::is_client()) { ?>
                            ...
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <?php if(User::can_edit_estimate()) { ?>
                                        <a class="dropdown-item" href="<?=base_url()?>estimates/edit/<?=$estimate->est_id?>">
                                        <?=lang('edit_estimate')?></a>
                                        <a class="dropdown-item" href="<?=base_url()?>estimates/email/<?=$estimate->est_id?>" data-toggle="ajaxModal"><?=lang('email_estimate')?></a>
                                       <a class="dropdown-item" href="<?=base_url()?>estimates/timeline/<?=$estimate->est_id?>">
                                        <?=lang('estimate_history')?></a>
                                    <?php } ?>
                                    <?php if($estimate->status != 'Declined'){ ?>
                                    <a class="dropdown-item" href="<?=base_url()?>estimates/status/declined/<?=$estimate->est_id?>"><?=lang('mark_as_declined')?></a>
                                    <?php } ?>
                                    ...
                                    <a class="dropdown-item" href="<?=base_url()?>estimates/status/accepted/<?=$estimate->est_id?>" <?=$convert_string;?>><?=lang('mark_as_accepted')?></a>
                                   
                                    <?php } ?>

                        <?php if(User::is_admin() || User::perm_allowed(User::get_id(),'delete_estimates')) { ?>
                                        <span class="divider"></span>
                                        <a class="dropdown-item" href="<?=base_url()?>estimates/delete/<?=$estimate->est_id?>" data-toggle="ajaxModal"><?=lang('delete_estimate')?></a>
                        <?php } ?>
            ...
            <?php } ?>
                        ...
                        <div class="col-sm-4 m-t-8">
                            <?php if ($estimate->client != 0) { ?>
                                ...
                                <a href="<?=base_url()?>fopdf/estimate/<?=$estimate->est_id?>" class="btn btn-sm btn-primary float-right m-r-2"><i class="fa fa-file-pdf-o"></i> <?=lang('pdf')?></a>
                                <?php elseif(config_item('pdf_engine') == 'mpdf') : ?>
                                <a href="<?=base_url()?>estimates/pdf/<?=$estimate->est_id?>" class="btn btn-sm btn-primary float-right m-r-2"><i class="fa fa-file-pdf-o"></i> <?=lang('pdf')?></a>
                                <?php endif; ?>
                            <?php } ?>
                ...
                <section class="ie-details">
                    ...
                    <div class="card m-b-0">
                        ...
                        <div class="row">
                            ...
                            <div class="col-8 text-right">
                                ...
                                <div><?=lang('estimate_date')?>:<span class="col-5 no-gutter-right float-right"><strong><?=strftime(config_item('date_format'), strtotime($estimate->date_saved));?></strong></span></div>
                                <div><?=lang('valid_until')?>:<span class="col-5 no-gutter-right float-right"><strong><?=strftime(config_item('date_format'), strtotime($estimate->due_date));?></strong></span></div>
                                <div><?=lang('estimate_status')?>:<span class="col-5 no-gutter-right float-right"><span class="badge bg-success"><?=$estimate->status?></span></span></div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 col-12">
                            ...
                            <p>
                                <span class="col-5 no-gutter"><?= lang('address') ?>:</span>
                                <span class="col-7 no-gutter">
                                ...
                                <span class="col-5 no-gutter"><?= lang('phone') ?>:</span>
                                <span class="col-7 no-gutter">
                                ...
                                <span class="col-5 no-gutter"><?= lang('fax') ?>:</span>
                                <span class="col-7 no-gutter">
                                ...
                                <span class="col-5 no-gutter"><?= lang('company_registration') ?>:</span>
                                <span class="col-7 no-gutter">
                                ...
                                <span class="col-5 no-gutter"><?=lang('company_vat')?>:</span>
                                <span class="col-7 no-gutter">
                                ...
                                <div class="col-lg-5">
                                    ...
                                    <p>
                                    <span class="col-4 no-gutter"><?= lang('address') ?>:</span>
                                    <span class="col-8 no-gutter">
                                    ...
                                    <?php if($client->VAT != ''){ ?>
                                    <span class="col-4 no-gutter"><?=lang('company_vat') ?>:</span>
                                    <span class="col-8 no-gutter"><?php echo $client->VAT; ?>
                                    </span>
                                    <?php } ?>
                                    </p>
                                    </div>
                    ...
                    <div class="col-lg-12">
                        ...
                        <p>
                            ...
                            <?php endif; ?>
                            <?php if (config_item('company_registration_'.$l) != '' || config_item('company_registration') != '') : ?>
                            <span class="col-4 no-gutter"><?= lang('company_registration') ?>:</span>
                            <span class="col-8 no-gutter">
                                <a href="tel:<?= (config_item('company_registration_' . $l) ? config_item('company_registration_' . $l) : config_item('company_registration')) ?>">
                                <?= (config_item('company_registration_' . $l) ? config_item('company_registration_' . $l) : config_item('company_registration')) ?></a>
                            </span>
