...
<div class="content">
	...
	<div class="row">
		...
		<div class="col-9 text-right m-b-0">
			<a href="<?=base_url()?>fopdf/estimate/<?=$est->est_id?>" class="btn btn-primary float-right"><i class="fa fa-file-pdf-o"></i> <?=lang('pdf')?></a>
		...
		<div class="col-sm-12">
			<div class="card panel-white">
				<div class="card-header">
					<h3 class="card-title"><?=lang('estimate_details')?> - <?=$est->reference_no?></h3>
				</div>
				<div class="card-body">
