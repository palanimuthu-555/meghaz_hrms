...
class Policies extends MX_Controller {
    ...
    function __construct()
    {
        ...
        if(!App::is_access('menu_policies'))
		{
     ...
     public function policies_list()
    {
		...
		if(App::is_permit('menu_policies','write'))
		{
			$style_w="";	
		}
		if(App::is_permit('menu_policies','delete'))
		{
			$style_d="";
		}
         ...
         foreach ($list as $policy) {
           ...
           $no++;
            ...
            if($des_length > 200)
            {
				...
				<div class="dropdown-menu float-right"><a class="dropdown-item" href="'.base_url().'policies/download/'.$policy->id.'"><i class="fa fa-download m-r-5"></i> Download</a>';
				$html.='<a class="dropdown-item" href="#" onclick="edit_policies('.$policy->id.')" style="'.$style_w.'"><i class="fa fa-pencil m-r-5"></i> Edit</a>
				<a class="dropdown-item" href="#" onclick="delete_policies('.$policy->id.')" style="'.$style_d.'"><i class="fa fa-trash-o m-r-5"></i> Delete</a>';
				$html.='</div></div>';
