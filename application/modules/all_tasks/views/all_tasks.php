 ...
 -->
							...
							<a href="<?php echo base_url(); ?>projects" class="btn back-btn bk-alt" ><i class="fa fa-chevron-left"></i>Back</a>			
										...
										<ul class="nav navbar-nav float-right chat-menu">
											<li class="dropdown">
												<a href="" class="" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-cog"></i></a>
														...
														<div class="chat chat-left">
															<div class="chat-avatar">
																<a  title="<?php echo $project_file['fullname']; ?>" data-placement="right" data-toggle="tooltip" class="avatar">
																	<img alt="<?php echo $project_file['fullname']; ?>" src="<?php echo $pro_pic_coms; ?>" class="img-responsive rounded-circle">
																</a>
															</div>
															<div class="chat-body">
									...
									<div class="message-bar">
										<form method="post" id="post_comments" enctype="multipart/form-data" action="<?php echo base_url();?>all_tasks/post_task_comments" class="message-inner">
											...
											<div class="message-area"><div class="input-group">
												...
												<!-- <span class=""> -->
													<button class="input-group-text btn btn-custom" type="submit"><i class="fa fa-send"></i></button>
												<!-- </span> -->
											</div>
												</div>
											</div>
