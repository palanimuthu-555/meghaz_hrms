		...
		<div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <?php if ($f->image_width > $f->image_height) {
                        ...
                        <div class="file-icon icon-large float-right">
                            <a href="<?=base_url()?>projects/files/preview/<?=$f->file_id?>/<?=$project?>" data-toggle="ajaxModal">
                            <img style="<?=$style?>" src="<?=$real_url?>" /></a>
                        </div>
                    <?php else : ?>
                        <div class="file-icon icon-large float-right"><i class="fa <?=$icon?> fa-5x"></i></div>
                    <?php endif; ?>
                    </div>
                    <div class="col-lg-9">
...
<div class="modal-dialog  modal-dialog-centered">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <img class="img-fluid" width="<?=$file->image_width?>" src="<?=base_url()?><?=$file_path?>"
...
<div class="modal-dialog  modal-dialog-centered">
	<div class="modal-content">
		...
		<!--<div class="modal-footer"> <a href="#" class="btn btn-default" data-dismiss="modal"><?=lang('close')?></a>
			<button type="submit" class="btn btn-primary"><?=lang('delete_button')?></button></div>-->
		</form>
	</div>
</div>
<!-- /.modal-content -->
