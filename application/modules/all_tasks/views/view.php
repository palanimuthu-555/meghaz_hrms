 ...
 -->
						...
						<div class="">
							<a href="<?php echo base_url(); ?>projects" class="btn back-btn bk-alt ml-0" ><i class="fa fa-chevron-left"></i>Back</a>			
						</div>
															...
															<ul id="task-list">
																	...
																	<li class="task <?php echo $cls; ?>">
																		<div class="task-container">
																			...
																			<a href="<?php if(App::is_permit('menu_tasks','read')){?><?php echo base_url();?>all_tasks/task_view/<?php echo $project_id['project_id']; ?>/<?php echo $tasks['t_id']; ?><?php }else{ echo '#';}?>">
																			<span class="task-label" contenteditable="true"><?php echo $tasks['task_name']; ?> </span>
																			</a>
																		<span class="task-action-btn task-btn-right">
																			<span class="tsk-status badge badge-<?php echo $class;?>"><?php echo $tasks['priority']?></span>
																			<!-- <?php if($cls == ''){ ?>
																				<span class="tsk-status label label-danger">Pending</span>
																			<?php }else{ ?>
																				<span class="tsk-status label label-success">Complete</span>
																			<?php } ?> -->
																			<span class="tsk-status badge badge-<?php echo @$task_board['task_board_class']?>"><?php echo  @$task_board['task_board_name'];?></span>
									...
									<div class="message-bar">
										<form method="post" id="post_comments"   enctype="multipart/form-data" action="#" class="message-inner">
											...
											<div class="message-area"><div class="input-group">
												...
												<!-- <span class=""> -->
													<button class="input-group-text btn btn-custom" id='_comment_upload' type="button"><i class="fa fa-send"></i></button>
												<!-- </span> -->
											</div>
												</div>
											</div>
