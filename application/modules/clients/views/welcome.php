<div class="content">
	...
	<div class="row">
		<?php if(App::is_access('menu_projects'))
		{?>
		<div class="col-md-8">
			<div class="card panel-table">
				<div class="card-header">
					<h3 class="card-title"><?=lang('recent_projects')?></h3>
				</div>
				<div class="card-body">
					<table class="table table-striped custom-table m-b-0">
						...
						<?php foreach (Welcome::recent_projects($user_company) as $key => $project) { ?>
							<tr>
								...
								<td class="text-right">
									<a class="btn btn-success btn-sm" href="<?=base_url()?>projects/view/<?=$project->project_id?>">
				...
				<div class="card-footer bg-white no-padder">
					<div class="row text-center no-gutter">
						<div class="col-3 b-r b-light">
	...
	<?php } if(App::is_access('menu_payments'))
		{?>
		<div class="col-lg-4">
	...
	<div class="row">
		...
		{?>
				<div class="col-lg-6">
					<div class="card panel-white">
						<div class="card-header">
							<h3 class="card-title"><?=lang('my_projects')?></h3>
						</div>
						<div class="card-body text-center">
				...
				<!-- Start Tickets -->
			<?php }  if(App::is_access('menu_tickets'))
		{?>
				<div class="col-lg-6">
					<div class="card panel-white">
						<div class="card-header">
							...
							<div class="list-group no-radius m-b-0">
								...
								foreach ($tickets as $key => $ticket) {
									...
									<a href="<?=base_url()?>tickets/view/<?=$ticket->id?>" data-original-title="<?=$ticket->subject?>" data-toggle="tooltip" data-placement="top" title = "" class="list-group-item">
										<?=$ticket->ticket_code?> - <small class="text-muted"><?=lang('priority')?>: <?=$ticket->priority?> <span class="badge bg-<?=$badge?> float-right"><?=$ticket->status?></span></small>
									</a>
								<?php } ?>
							</div>
						</div>
		...
		<?php } if(App::is_access('menu_activites'))
		{?>
		<!-- Recent activities -->
		<div class="col-md-4">
			<div class="card activity-panel">
				<div class="card-header">
					<h3 class="card-title"><?= lang('recent_activities') ?></h3>
				</div>
				<div class="card-body">
							...
							<li>
								<div class="activity-user">
									<a href="javascript:void(0);" class="avatar">
										<img class="rounded-circle" src="<?php echo User::avatar_url($activity->user); ?>">
									</a>
								</div>
