<section id="content">
          <section class="hbox stretch">
            ...
            <aside>
              <section class="vbox">
               <header class="header bg-white b-b b-light">
                  <a href="#aside" data-toggle="class:show" class="btn btn-sm btn-primary float-right"><i class="fa fa-plus"></i> <?=lang('new_user')?></a>
				...
				<?php  echo modules::run('sidebar/flash_msg');?>
					<section class="card panel-default card-body">
			...
			foreach ($users as $key => $user) { ?>
									<tr>
									<td><a class="float-left thumb-sm avatar">
									<img src="<?=base_url()?>assets/avatar/<?=$user->avatar?>" class="rounded-circle"></a>
									</td>
					...
					<td>
					<a href="<?=base_url()?>users/view/update/<?=$user->user_id?>" class="btn btn-default btn-sm" data-toggle="ajaxModal" title="<?=lang('edit')?>"><i class="fa fa-pencil"></i> </a>
					<?php
					if ($user->username != $this->tank_auth->get_username()) { ?>
					<a href="<?=base_url()?>users/account/delete/<?=$user->user_id?>" class="btn btn-danger btn-sm" data-toggle="ajaxModal" title="<?=lang('delete')?>"><i class="fa fa-trash-o"></i></a>
					<?php } ?>
					</td>
									</tr>
									<?php } } ?>
