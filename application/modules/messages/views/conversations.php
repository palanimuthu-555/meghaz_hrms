									...
									<div class="card-box">
										...
										<div class="email-header">
											...
											<div class="row">
												...
												<div class="col-12 col-sm-6 float-right top-action-left">
													...
													<?php echo form_open(base_url().'messages/search/'); ?>
														...
														<div class="input-group">
															...
															<span class="input-group-text p-0"> <button class="btn btn-md" type="submit">Go!</button></span>
															</div>
														</div>
															...
															echo form_open(base_url().'messages/send', $attributes); ?>
																...
																<div class="message-cont">
																	...
																	<div class="message-send-btn">
																		...
																		<button class="btn btn-success float-right btn-sm m-t-3" id="send_message_conversation" type="submit"><?=lang('send_message')?></button>
														...
														foreach (Message::conversation($user_from) as $key => $msg) { ?>
															...
															<article class="comment-item">
																...
																<a class="float-left thumb-sm avatar">
																	...
																	<img src="<?php echo User::avatar_url($msg->user_from); ?>" class="rounded-circle">
																...
																<section class="comment-body card panel-default">
																	...
																	<header class="card-header bg-white">
																		...
																		<span class="text-muted m-l-sm float-right">
																			...
																			<a href="<?=base_url()?>messages/delete/<?=$msg->msg_id?>" data-toggle="ajaxModal" class="btn btn-danger btn-sm active"><i class="fa fa-trash-o text-white text-active"></i>
