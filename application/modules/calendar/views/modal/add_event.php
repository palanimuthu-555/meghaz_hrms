			 ...
			 <div class="form-group">
					...
					<div class="row">
						...
						<div class="col-sm-4">
							 <div class='time-icon date time_picker'> 
								 <input type="text" class="form-control datetimepicker-input event_time" data-toggle="datetimepicker" name="from_time"  />
							</div>	
						</div>
					</div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                             <div class='time-icon date time_picker'> 
                                 <input type="text" class="form-control datetimepicker-input event_time" data-toggle="datetimepicker" name="to_time"  />
                            </div>  
                        </div>
                    </div>
                </div>
