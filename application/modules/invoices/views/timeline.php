                    ...
                    <div class="row">
                            ...
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <?php if (User::is_admin() || User::perm_allowed(User::get_id(),'email_invoices')) { ?>
                                            ...
                                            <a class="dropdown-item" href="<?= base_url() ?>invoices/send_invoice/<?= $inv->inv_id ?>" data-toggle="ajaxModal" title="<?= lang('email_invoice') ?>"><?= lang('email_invoice') ?></a>
                                   

                                    <?php } if (User::is_admin() || User::perm_allowed(User::get_id(),'send_email_reminders')) { ?>
                                 
                                            <a class="dropdown-item" href="<?=base_url() ?>invoices/remind/<?= $inv->inv_id ?>" data-toggle="ajaxModal" title="<?=lang('send_reminder');?>"><?=lang('send_reminder')?></a>
                        ...
                        <div class="col-sm-3 float-right">
                            ...
                            <?php elseif (config_item('pdf_engine') == 'mpdf') : ?>
                                <a href="<?=base_url() ?>invoices/pdf/<?=$inv->inv_id?>" class="btn btn-sm btn-primary float-right"><i class="fa fa-file-pdf-o"></i> <?=lang('pdf')?></a>
                            <?php endif; ?>
                        </div>
                    </div>
                </header>
<div class="padding-2p">
                ...
                <img src="<?=User::avatar_url(User::get_id())?>" class="rounded">
