	...
	<div class="row">
		<div class="col-6">
            ...
            <ul class="breadcrumb mb-3">
                ...
                <li class="breadcrumb-item"><a href="<?=base_url()?>invoices"><?=lang('invoice')?></a></li>
                <li class="breadcrumb-item active">Edit Invoice</li>
            </ul>
		</div>
		<div class="col-6 text-right m-b-0">
			<?php $i = Invoice::view_by_id($id); ?>
				<a href="<?=base_url()?>invoices/view/<?=$i->inv_id?>" data-original-title="<?=lang('view_details')?>" data-toggle="tooltip" data-placement="bottom" class="btn btn-primary rounded float-right"><i class="fa fa-info-circle"></i> <?=lang('invoice_details')?></a>
		</div>
	</div>
                    ...
                    <div class="col-sm-12">
                        <div class="card panel-white">
                            <div class="card-header">
								<h3 class="card-title mb-0"><?=lang('invoice_details')?> - <?=$i->reference_no?></h3>
							</div>
                            <div class="card-body">
                                <?php
    ...
    <?php // } else{ ?>
        ...
        <?php // } ?>
								...
								<div class="text-center submit-section">
									<button type="submit" class="btn btn-primary btn-lg submit-btn" id="invoice_edit_submit"> <?=lang('save_changes')?></button>
								</div>
                                </form>
                            </div>
                        </div>
