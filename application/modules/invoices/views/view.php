                    ...
                    <div class="row">
						<div class="col-md-12">
                            ...
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <?php if(User::is_admin() || User::perm_allowed(User::get_id(),'email_invoices')): ?>
                                            ...
                                            <a class="dropdown-item" href="<?=base_url()?>invoices/send_invoice/<?=$inv->inv_id?>" data-toggle="ajaxModal"
                                    ...
                                    <?php if(User::is_admin() || User::perm_allowed(User::get_id(),'send_email_reminders')) : ?>
                                            ...
                                            <a class="dropdown-item" href="<?=base_url()?>invoices/remind/<?=$inv->inv_id?>" data-toggle="ajaxModal"
                                    ...
                                    <?php endif; ?>
                                        ...
                                        <a class="dropdown-item" href="<?= base_url() ?>invoices/transactions/<?= $inv->inv_id ?>">
                                            <?= lang('payments') ?>
                                        </a>
                                    ...
                                    <?php if(User::is_admin() && Invoice::get_invoice_due_amount($inv->inv_id) > 0) : ?>
                                            ...
                                            <a class="dropdown-item" href="<?=base_url() ?>invoices/mark_as_paid/<?=$inv->inv_id?>" data-toggle="ajaxModal">
                                                <?=lang('mark_as_paid') ?>
                                            </a>
                                  

                                    
                                            <a class="dropdown-item" href="<?=base_url() ?>invoices/cancel/<?=$inv->inv_id?>" data-toggle="ajaxModal">
                                                <?=lang('cancelled') ?>
                                            </a>
                            ...
                            <?php elseif (config_item('pdf_engine') == 'mpdf') : ?>
                                <a href="<?= base_url() ?>invoices/pdf/<?= $inv->inv_id ?>" class="btn btn-sm btn-primary float-right m-r-2">
                                    <i class="fa fa-file-pdf-o"></i> <?=lang('pdf') ?>
                                </a>
...
<?php } ?>
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-9 col-sm-6 text-right" style="color: #817d7d;">
								<h3 class="text-uppercase"><?=$inv->reference_no?> <?php if ($inv->recurring == 'Yes') { ?>
                                        <span class="badge bg-danger"><i class="fa fa-retweet"></i>
                                ...
                                <div>
                                    <?=lang('invoice_date')?>
                                    <span class="col-5 no-gutter-right float-right">
                                    <strong>
                                ...
                                <?php if (config_item('swap_to_from') == 'FALSE') { ?>
                                    ...
                                    <div class="col-sm-6 col-md-6 col-lg-3 m-b-20">
                                        ...
                                        <p>
                                            ...
                                            <span class="col-3 no-gutter"><?= lang('address') ?>:</span>

                                <span class="col-9 no-gutter">
                                ...
                                ?><br>
                                    ...
                                    <?=(config_item('company_country_' . $l)
                                        ...
                                        : config_item('company_country')) ?>
                                            ...
                                            <span class="col-3 no-gutter"><?= lang('phone') ?>:</span>
                                <span class="col-9 no-gutter">
                                <a href="tel:<?= (config_item('company_phone_' . $l)
                                    ...
                                    <?php endif; ?>
                                            ...
                                            <?php if (config_item('company_fax_'.$l) != '' || config_item('company_fax') != '') : ?>
                                                <span class="col-3 no-gutter"><?= lang('fax') ?>:</span>
                                                <span class="col-9 no-gutter">
                                    ...
                                    <?=(config_item('company_fax_' . $l)
                                        ...
                                        : config_item('company_fax')) ?>
                                            ...
                                            <?php if (config_item('company_registration_'.$l) != '' || config_item('company_registration') != '') : ?>
                                                <span class="col-3 no-gutter"><?= lang('company_registration') ?>:</span>
                                                <span class="col-9 no-gutter">
                                ...
                                <a href="tel:<?= (config_item('company_registration_' . $l) ? config_item('company_registration_' . $l) : config_item('company_registration')) ?>">
                                    <?=(config_item('company_registration_' . $l)
                                        ...
                                        : config_item('company_registration')) ?>
                                            ...
                                            <span class="col-3 no-gutter"><?=lang('company_vat')?>:</span>
    ...
    <a href="<?=site_url()?>invoices/add_expenses/<?=$inv->client?>/<?=$inv->inv_id?>" class="btn btn-sm btn-danger" data-toggle="ajaxModal"><?=lang('expenses_available')?></a>
    </span>
                            ...
                            <?php if (User::is_admin() || User::perm_allowed(User::get_id(),'edit_all_invoices')) { ?>
                                ...
                                <?php if ($inv->status != 'Paid') { ?>
                                    <tr class="hidden-print">
                                        ...
                                        <td><input id="auto-quantity" type="text" name="quantity" value="1" class="form-control" style="width: 55px;" ></td>
                                        <?php if ($showtax) : ?>
                                            <td>
                                        ...
                                        <?php endif; ?>
                                        <td><input id="auto-unit-cost" type="text" name="unit_cost" required placeholder="50.56" class="form-control" style="  width: 95px;" ></td>
                                        <?php if ($showtax) : ?>
                                            <td><input type="text" name="tax" placeholder="0.00" readonly="" class="form-control" style="width: 100px;"></td>
                                        <?php endif; ?>
                                        <td></td>
