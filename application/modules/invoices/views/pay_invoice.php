                ...
                <header class="header-fixed clearfix hidden-print">
                    <div class="row m-t-sm">
                        ...
                        <div class="col-sm-3 m-b-xs float-right">
                            <?php if (config_item('pdf_engine') == 'invoicr') : ?>
                                <a href="<?=base_url()?>fopdf/invoice/<?=$inv->inv_id?>" class="btn btn-sm btn-primary float-right">
                                    <i class="fa fa-file-pdf-o"></i> <?=lang('pdf')?>
                                </a>
                            <?php elseif (config_item('pdf_engine') == 'mpdf') : ?>
                                <a href="<?=base_url()?>invoices/pdf/<?=$inv->inv_id?>" class="btn btn-sm btn-primary float-right">
                                    <i class="fa fa-file-pdf-o"></i> <?= lang('pdf') ?>
                                </a>
                            <?php endif; ?>
                        </div>
