	...
	<div class="row">
		...
		<div class="col-12">
			...
			<ul class="breadcrumb">
				...
				<li class="breadcrumb-item active"><?=lang('create_invoice')?></li>
			</ul>
				...
				<div class="card-body">
					...
					<?php echo validation_errors(); ?>
						...
						<div class="text-center submit-section">
							...
							<button type="submit" id="invoice_create_submit" class="btn btn-primary btn-lg submit-btn"><i class="fa fa-plus"></i> <?=lang('create_invoice')?></button>
