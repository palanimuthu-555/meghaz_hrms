		...
		<?php $attributes = array('class' => 'bs-example form-horizontal','id'=>'invoiceEmailForm'); echo form_open(base_url().'invoices/send_invoice',$attributes); ?>
			<div class="modal-body">
				...
				<div class="form-group">
					<label class="col-lg-12 control-label"><?=lang('subject')?> <span class="text-danger">*</span></label>
					<div class="col-lg-12">
				...
				<div class="form-group">
					<label class="col-lg-12 control-label"><?=lang('cc_self')?> ( <span class="it"><?=User::login_info(User::get_id())->email?></span> )</label>
					<div class="col-lg-5">
						<label class="switch">
