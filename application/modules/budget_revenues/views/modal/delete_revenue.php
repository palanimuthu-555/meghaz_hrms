...
<div class="modal-dialog  modal-dialog-centered">
	<div class="modal-content">
		...
		<?php echo form_open(base_url().'expenses/delete'); ?>
			...
			<div class="modal-footer text-center" style="text-align:center;"> <a href="#" class="btn btn-default" style="min-width:100px" data-dismiss="modal"><?=lang('close')?></a>
				<button type="submit" class="btn btn-danger" style="min-width:100px"><?=lang('delete_button')?></button>
			</div>
		</form>
	</div>
</div>