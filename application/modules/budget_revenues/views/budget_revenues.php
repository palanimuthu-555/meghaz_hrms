          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Budget revenues</li>
                </ul>
            </div>

            <div class="col-md-6 text-right m-b-30">

			<?php if(App::is_permit('menu_budget_revenues','create'))
			{
			?>  
             <a href="<?=base_url()?>budget_revenues/create" data-toggle="ajaxModal" title="<?=lang('create_revenue')?>" class="btn btn-primary add-btn float-right"><i class="fa fa-plus"></i> <?=lang('create_revenue')?></a>
		<?php
			}
			?>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="table-responsive">
                <table class="table table-striped custom-table AppendDataTables" id="table-budget-revenue">
                  <thead>
                    <tr>
                      <th>No</th>
                      <th>Notes</th>                    
                     ...
                     <!-- <th>Total Revenue</th>
                      ...
                      <th>Revenue Date</th>
					<?php 
					if(App::is_permit('menu_budget_revenues','write')==true|| App::is_permit('menu_budget_revenues','delete')==true)
					{
						...
						<td class="text-right">
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu float-right">
                              <?php if(App::is_permit('menu_budget_revenues','write')){ ?><a class="dropdown-item" href="<?php echo base_url(); ?>budget_revenues/edit/<?php echo $budget['id']; ?>" data-toggle="ajaxModal"><i class="fa fa-pencil m-r-5"></i> Edit</a><?php }?>
                              <?php if(App::is_permit('menu_budget_revenues','delete')){ ?><a class="dropdown-item" href="#" data-toggle="modal" data-target="#delete_budget<?php echo $budget['id']; ?>"><i class="fa fa-trash-o m-r-5"></i> Delete</a><?php }?>
                            </div>
