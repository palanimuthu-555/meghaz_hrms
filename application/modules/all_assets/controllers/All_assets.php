...
class All_assets extends MX_Controller
{
    ...
    public function add()
    {
        if($_POST)
        {
            $_POST['purchase_date']=date("Y-m-d", strtotime($this->input->post('purchase_date')));
            $_POST['warranty_date']=date("Y-m-d", strtotime($this->input->post('warranty_date')));
