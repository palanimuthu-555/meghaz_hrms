<div class="content">
	...
	<div class="row">
		<div class="col-lg-6">
			...
			<div class="card">
				<div class="card-header">
					<h6 class="card-title"><?=lang('profile_details')?></h6>
				</div>
				<div class="card-body">
					<?php
		...
		<div class="col-lg-6">
			...
			<div class="card">
				<div class="card-header">
					<h6 class="card-title"><?=lang('account_details')?></h6>
				</div>
				<div class="card-body">
					<?php
			...
			<div class="card m-t-3">
				<div class="card-header">
					<h6 class="card-title"><?=lang('avatar_image')?></h6>
				</div>
				<div class="card-body">
					<?php
					...
					echo form_open_multipart(base_url().'profile/changeavatar',$attributes); ?>
						...
						<div class="form-group position-relative">
							<label class="control-label"><?=lang('avatar_image')?></label>
							<div class="">
			...
			<div class="card m-t-3">
				<div class="card-header">
					<h6 class="card-title"><?=lang('change_username')?></h6>
				</div>
				<div class="card-body">
					<?php
					$attributes = array('class' => 'bs-example form-horizontal');
