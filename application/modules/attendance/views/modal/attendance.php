								                    ...
								                    $a_days -=1;
								                     ...
								                     $month_days_in_outs =  unserialize($record['month_days_in_out']);
								                      ...
								                      foreach ($month_days_in_outs[$a_days] as $punch_details) 
								                      {
								                        ...
								                        {
								                        	if(!empty($punch_details['punchin_location']['location'])){
								                        		$punchin_loc = '['.$punch_details['punchin_location']['location'].']';
								                        	}else{
								                        		$punchin_loc = '-';
								                        	}
								                          echo'<li>
								                                <p class="mb-0">Punch In at '.$punchin_loc.'</p>
								                        ...
								                        {
								                        	if(!empty($punch_details['punchout_location']['location'])){
								                        		$punchout_loc = '['.$punch_details['punchout_location']['location'].']';
								                        	}else{
								                        		$punchout_loc = '-';
								                        	}

								                           echo'<li>
								                                <p class="mb-0">Punch Out at '.$punchout_loc.'</p>
								                                <p class="res-activity-time">
								                                  <i class="fa fa-clock-o"></i>
