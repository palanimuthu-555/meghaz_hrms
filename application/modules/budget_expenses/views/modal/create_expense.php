		...
		<?php $attributes = array('class' => 'bs-example form-horizontal','id' => 'createExpenseForm'); echo form_open_multipart(base_url().'budget_expenses/create',$attributes); ?>
			<div class="modal-body">
				<div class="form-group form-row">
					<label class="col-lg-12 control-label"><?=lang('amount')?> <span class="text-danger">*</span></label>
					<div class="col-lg-6">
			 ...
			 <div class="form-group">
				...
				<div class="form-group">
					<label class="col-lg-12 control-label"><?=lang('sub_category')?> <span class="text-danger">*</span></label>
					<div class="col-lg-12">
				...
				<div class="form-group position-relative">
					...
					<div class="col-lg-12">
						<label class="btn btn-default btn-choose" style="top:3px;left:20px">Choose File</label>
