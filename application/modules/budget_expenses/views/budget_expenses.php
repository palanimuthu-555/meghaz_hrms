            ...
            <div class="col-md-6">
              <h4 class="page-title">Budget Expenses</h4>
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Budget Expenses</li>
                </ul>
            </div>

			<div class="col-md-6 text-right m-b-30">

			<?php if(App::is_permit('menu_budget_expenses','create'))
			{
			?> 
			<a href="<?=base_url()?>budget_expenses/create" data-toggle="ajaxModal" title="<?=lang('create_expense')?>" class="btn btn-primary add-btn float-right"><i class="fa fa-plus"></i> <?=lang('create_expense')?></a>
			<?php
			}
			?>
			</div>
            ...
            <form id="timesheet_search" method="post" action="<?php echo base_url().'budget_expenses/'; ?>">
                  <div class="row">
                    ...
                    <div class="form-group mb-1">
                        <button id="budget-revenuet_search_btn" class="btn btn-primary form-control" > Search </button>  <!-- 
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="table-responsive">
                <table class="table table-striped custom-table AppendDataTables" id="table-budget-expense">
                  <thead>
                    <tr>
                      <th>No</th>
                      <th>Notes</th>                    
                     ...
                     <!-- <th>Total Revenue</th>
                      ...
                      <th>Expense Date</th>
                      <?php
					  if(App::is_permit('menu_budget_expenses','write')==true|| App::is_permit('menu_budget_expenses','delete')==true)
					  {
                  ...
                  <tbody>
                    <?php $i = 1; foreach($budget_expenses as $budget){ 
                      ...
                      <tr>
                        ...
                        <td style="text-align: center;"><?php echo wordwrap($budget['notes'],50,"<br>\n")?></td>
						...
						<td class="text-right">
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu float-right">
                              <?php if(App::is_permit('menu_budget_expenses','write')){?><a class="dropdown-item" href="<?php echo base_url(); ?>budget_expenses/edit/<?php echo $budget['id']; ?>" data-toggle="ajaxModal"><i class="fa fa-pencil m-r-5"></i> Edit</a><?php }?>
                              <?php if(App::is_permit('menu_budget_expenses','delete')){?><a class="dropdown-item" href="#" data-toggle="modal" data-target="#delete_budget<?php echo $budget['id']; ?>"><i class="fa fa-trash-o m-r-5"></i> Delete</a><?php }?>
                            </div>
                          </div>
                        </td>
					<?php
