			...
			<div class="card-box">
				...
				<ul class="list-group no-radius m-b-0">
					<li class="list-group-item">
						...
						<span class="float-right"><?=strftime(config_item('date_format')." %H:%M:%S", strtotime($inf->expense_date));?></span>
					</li>
					<li class="list-group-item">
					...
					<li class="list-group-item">
						...
						<span class="float-right"><?=($inf->billable == '1') ? '<span class="badge badge-success">Yes</span>' : '<span class="label label-danger">No</span>';?></span>
					</li>
					<li class="list-group-item">
						<span class="text-muted"><?=lang('invoiced')?></span>
						<span class="float-right"><?=($inf->invoiced == '1') ? '<span class="badge badge-success">Yes</span>' : '<span class="label label-danger">No</span>';?></span>
					</li>
					<li class="list-group-item">
