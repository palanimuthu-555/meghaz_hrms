						...
						<div class="col-md-12">
							<div class="card-box">
								<ul class="nav nav-tabs nav-tabs-bottom">
									<li class="nav-item"><a class="active nav-link" href="#okr_tab" data-toggle="tab">OKRs</a></li>
									<li class="nav-item"><a class="nav-link" href="#kpi_tab" data-toggle="tab">KPI</a></li>
									<li class="nav-item"><a class="nav-link" href="#smart_goals_tab" data-toggle="tab">Smart Goals</a></li>
									<li class="nav-item"><a class="nav-link" href="#compentency_tab" data-toggle="tab">Compentencies or BARS</a></li>
								</ul>
