<div class="modal-dialog modal-dialog-centered">
	<div class="modal-content">
     ...
     <?php  }
		...
		<?php 
			$attributes = array('class' => 'bs-example','id'=> 'addJobTypes'); echo form_open_multipart('all_jobtypes/add', $attributes); 
			if(isset($job_type['id'])&&!empty($job_type['id'])) 
            {    ?>
     ...
     <?php  } ?>
			<div class="modal-body">
				...
				<div class="submit-section">
					<button class="btn btn-primary submit-btn submit_JobTypes">Submit</button>
				</div>
			</div>
		</form>
	</div>
