            ...
            <ul class="nav">
                ...
                <li class="<?php
                    ...
                    <a href="<?=base_url()?><?=$menu->route?>">
                        ...
                        <span class="float-right"> <i class="fa fa-angle-down text"></i> <i class="fa fa-angle-up text-active"></i></span>
                                                                ...
                                                                <ul class="sticky list-unstyled m-b-0">
                                                                    <li>
                                                                        <a href="javascript:;" id="profileCollapse" class=""> 
                                                                            <img class="stick-icon effect-fadeout hover-animate img img-fluid" src="<?php echo base_url(); ?>images/man-user.svg" />
                                                                        </a>
                                                                    </li>                                                                    
