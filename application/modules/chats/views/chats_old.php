				...
				<div class="user-details mr-auto">
					<div class="float-left user-img">
						<a class="avatar" href="javascript:void(0);" title="">
							<img src="" alt="" id="MsgviewUserChat" class="rounded-circle">
...
<div class="call-users user-list">
            ...
            <div class="container-fluid vccontainer group_vccontainer hidden card">
                    <div class="vcrow">
                        <div class="vccol vccollarge">
                            <div class="vcvideo">
                                <div class="videoinner">
                                    <div class="to_group_video hidden"><?php echo $group_name; ?></div>
                                    <img src="<?php echo base_url().'assets/img/user.jpg'; ?>" class="rounded-circle img-fluid center-block hidden mt-4" id="inner_image">
