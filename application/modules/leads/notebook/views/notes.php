              ...
              <aside class="aside-xl notes-left" id="note-list">
                <section class="vbox flex">
                  <header class="notes-header clearfix">
                    <span class="float-right m-t"><button class="btn btn-custom btn-sm btn-icon" id="new-note" data-toggle="tooltip" data-placement="right" title="New"><i class="fa fa-plus"></i></button></span>
                    <p class="h3"><?=lang('notes')?></p>
                    <div class="input-group m-t-sm m-b-sm">
                      <span class="input-group-prepend input-sm btn-success"><i class="fa fa-search"></i></span>
