		...
		<div class="row">
			<div class="col-md-12">
				<div class="profile-view">
							...
							<div class="col-md-7">
								<ul class="personal-info">
									...
									<li>
										...
										<span class="text"><?php echo $employee_details['username']; ?></span>
									</li>
									<li>
									...
									<li>
										...
										<span class="text"><?php echo ucfirst($employee_details['gender']); ?></span>
									</li>
									<li>
					...
					<?php if(App::is_permit('all_employees','write')){?><div class="pro-edit"><a href="#" class="edit-icon" data-toggle="modal" data-target="#profile_info"><i class="fa fa-pencil"></i></a></div><?php }?>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="row user-tabs">
			<div class="col-lg-12 col-md-12 col-sm-12 line-tabs">
				<ul class="nav nav-tabs nav-tabs-bottom">
					<li class="nav-item"><a class="active nav-link" href="#emp_profile" data-toggle="tab">Profile</a></li>
					<?php if(($this->session->userdata('role_id') != 2) && ($this->session->userdata('role_id') != 3)){ ?>
					<li class="nav-item"><a class="nav-link" href="#bank_statutory" data-toggle="tab">Bank & Statutory</a></li>
					<li class="nav-item"><a class="nav-link" href="#tab_additions" data-toggle="tab">Payroll Addition</a></li>
					<li class="nav-item"><a class="nav-link" href="#tab_deductions" data-toggle="tab">Payroll Deduction</a></li>
					<?php } ?>
					<?php if($this->session->userdata('role_id') == 3){ ?>
						<li class="nav-item"><a class="nav-link" href="#tab_overtime" data-toggle="tab">Overtime</a></li>
					<?php } ?>
					<?php if($check_teamlead['is_teamlead'] == 'yes'){ ?>
						<li class="nav-item"><a class="nav-link" href="#tab_teamovertime" data-toggle="tab">Team Overtime</a></li>
					<?php } ?>
					<li class="nav-item"><a class="nav-link" href="#tab_leaves" data-toggle="tab">Leaves</a></li>
				</ul>
			</div>
		</div>
	</div>
							...
							<div class="row">
								<div class="col-md-6">
									<div class="card-box profile-box">
										<h3 class="card-title">Personal Informations <?php if(App::is_permit('all_employees','write')){?><a href="#" class="edit-icon" data-toggle="modal" data-target="#personal_info_modal"><i class="fa fa-pencil"></i></a><?php }?></h3>
										<ul class="personal-info">
											<li>
											...
											<li>
												...
												<span class="text"><?php if($personal_info->passport_expiry)echo date('d M Y',strtotime($personal_info->passport_expiry)); ?></span>
											</li>
											<li>
								...
								<div class="col-md-6">
									...
									<div class="card-box profile-box">
										<h3 class="card-title">Emergency Contact <?php if(App::is_permit('all_employees','write')){?><a href="#" class="edit-icon" data-toggle="modal" data-target="#emergency_contact_modal"><i class="fa fa-pencil"></i></a><?php }?></h3>
							...
							<div class="row">
								<div class="col-md-6">
									<div class="card-box profile-box">
										...
										<h3 class="card-title">Bank information <?php if(App::is_permit('all_employees','write')){?><a href="#" class="edit-icon" data-toggle="modal" data-target="#bank_iformation_modal"><i class="fa fa-pencil"></i></a> <?php } ?></h3>
										<ul class="personal-info">
											<li>
								...
								<div class="col-md-6">
									<div class="card-box profile-box">
										<h3 class="card-title">Family Informations <?php if(App::is_permit('all_employees','write')){?><a href="#" class="edit-icon" data-toggle="modal" data-target="#family_info_modal"><i class="fa fa-pencil"></i></a><?php }?></h3>
							...
							<div class="row">
								<div class="col-md-6">
									<div class="card-box user-box">
										<h3 class="card-title">Education Informations <?php if(App::is_permit('all_employees','write')){?> <a href="#" class="edit-icon" data-toggle="modal" data-target="#education_info"><i class="fa fa-pencil"></i></a><?php }?></h3>
								...
								<div class="col-md-6">
									<div class="card-box user-box">
										<h3 class="card-title">Experience <?php if(App::is_permit('all_employees','write')){?><a href="#" class="edit-icon" data-toggle="modal" data-target="#experience_info"><i class="fa fa-pencil"></i></a><?php }?></h3>
										<div class="experience-box">
											<ul class="experience-list">
												...
												<div class="form-group">
													...
													<div class="input-group">
														<div class="input-group-prepend">
															<span class="input-group-text"><?=config_item('default_currency_symbol')?></span>
														</div>
							...
							<div class="payroll-table card">
								...
								<table class="table table-hover table-radius">
									...
									<tbody>
										...
										?>
									<?php  }else{ ?>
						 <tr><td class="text-center" colspan="5">No details were found</td></tr>
						 <?php } ?>  
									</tbody>
								</table>
							</div>
							...
							// }
								if($check_teamlead['is_teamlead'] == 'yes'){ 
								 ...
								 <?php } } ?>
									...
									<?php }  ?>
									<?php  }else{ ?>
						 <tr><td class="text-center" colspan="6">No details were found</td></tr>
						 <?php } ?>  
									</tbody>
								</table>
							</div>
							...
							<div class="payroll-table card">
								...
								if($check_teamlead['is_teamlead'] == 'yes'){ 
								 ...
								 <?php } } ?>
									...
									<?php } ?>
									<?php  }else{ ?>
						 <tr><td class="text-center" colspan="7">No details were found</td></tr>
						 <?php } ?>  
									</tbody>
								</table>
							</div>
							...
							<div class="payroll-table card">
								...
								<table class="table table-hover table-radius">
									...
									<tbody>
										...
										<?php $i++; }  ?>
										<?php  }else{ ?>
						 <tr><td class="text-center" colspan="4">No details were found</td></tr>
						 <?php } ?>  
									</tbody>
								</table>
							</div>
											...
											<div class="row">
												<div class="col-md-6">
													<div class="form-group">
														...
														<input type="text" class="form-control" name="full_name" value="<?php echo $employee_details['username']; ?>">
										...
										<div class="col-sm-6">
											...
											<div class="form-group">
												<?php $get_designation = $this->db->get_where('designation',array('id'=>$employee_details['designation_id']))->row_array(); 
													$all_designation = $this->db->get_where('designation',array('department_id'=>$employee_details['department_id']))->result_array(); 
											...
											<select class="form-control" style="width:100%;" name="designations" id="designations" <?php echo ($this->session->userdata('user_id') == $employee_details['user_id'])?"disabled":"";?>>
												<?php foreach ($all_designation as $designation) {?>												
													<option value="<?php echo $designation['id'];?>" <?php echo ($get_designation['id'] == $designation['id'])?'selected':'';?> ><?php echo $designation['designation'];?></option>
											<?php } ?>
												</select>
 ...
 -->
										...
										<?php }?>
											...
											<select class="form-control" style="width:100%;" name="user_type" id="user_type" <?php echo ($this->session->userdata('user_id') == $employee_details['user_id'])?"disabled":"";?>>
												<option value="<?php echo $get_usertype['r_id']?$get_usertype['r_id']:'';?>" selected ><?php echo $get_usertype['r_id']?ucfirst($get_usertype['role']):'Select';?></option>
												<?php
															 if(!empty($user_type))	{
															 foreach ($user_type as $usertype){ ?>
																<option value="<?=$usertype->r_id?>"><?php echo ucfirst($usertype->role);?></option>
															<?php } ?>
															<?php } ?>
												</select>
									...
									<div class="form-scroll">
										<div class="card-box AllFamilyMembers">
											...
											<div class="FamilyMembers">
												<h3 class="card-title">Family Member </h3><?php if($i != 1) { ?> <a href="#" class="btn btn-danger btn-sm remove_family_div"><i class="fa fa-trash-o"></i></a> <?php } ?>
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
								...
								<form method="post" id="education_info_form" action="<?php echo base_url(); ?>employees/education_info_add/<?php echo $employee_details['user_id']; ?>">
									<div class="form-scroll AllInstitute">
										...
										<div class="card-box MultipleInstitutions">
											<h3 class="card-title">Education Informations</h3> <?php if($i != 1) { ?> <a href="#" class="remove_div btn btn-sm btn-danger"><i class="fa fa-trash-o"></i></a> <?php } ?>
											<div class="row">
												<div class="col-md-6">
												...
												<div class="col-md-6">
													<div class="form-group form-focus focused">
														...
														<label class="control-label">Complete Date <span class="text-danger">*</span></label>
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group form-focus focused">
				...
				<form method="post" id="experience_info_form" action="<?php echo base_url(); ?>employees/experience_info_add/<?php echo $employee_details['user_id']; ?>">
					<div class="form-scroll">
						<div class="card-box AllExperience">
							...
							<h3 class="card-title">Experience Informations </h3> <?php if($i != 1){ ?> <a href="#" class="btn btn-sm btn-danger remove_exp_div"><i class="fa fa-trash-o"></i></a><?php } ?>
							<div class="row">
								<div class="col-md-6">
							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group form-focus">
										...
										<label class="control-label">Job Position <span class="text-danger">*</span></label>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group form-focus">
...
<!-- /Experience Modal -->
				...
				<!-- Add Addition Modal -->
				<div id="add_addition" class="modal fade" role="dialog">
						...
						<div class="modal-content">
							...
							<div class="modal-body">
								<form method="post" id="addtional_form" action="<?php echo base_url(); ?>employees/addtional_pf_details">
									...
									<div class="form-group">
										<label>Unit Amount <span class="text-danger">*</span></label>
									<div class="input-group">
				...
				<!-- Edit Addition Modal -->
				<div id="edit_addition<?php echo $add_ar['id']; ?>" class="modal fade" role="dialog">
					<div class="modal-dialog modal-dialog-centered" role="document">
						<div class="modal-content">
							<div class="modal-header">
							...
							<div class="modal-body">
								<form method="post" id="edit_addtional_form" action="<?php echo base_url(); ?>employees/edit_additional/<?php echo $add_ar['id']; ?>">
									...
									<div class="input-group">
									 ...
									 <input type="text" class="form-control" name="unit_amount" id="unit_amount" value="<?php echo $add_ar['unit_amount']; ?>" placeholder="Unit Amount">
									  <div class="input-group-append">
									    <span class="input-group-text">.00</span>
									  </div>
									</div>
				...
				<div class="modal fade" id="delete_addition<?php echo $add_ar['id']; ?>" role="dialog">
				...
				<div id="add_overtime" class="modal fade" role="dialog">
					<div class="modal-dialog modal-dialog-centered" role="document">
						<div class="modal-content">
							...
							<div class="modal-body">
								<form action="<?php echo base_url();?>employees/add_overtime"  id="add_overtimes" method="post" enctype="multipart/form-data" > 
									<div class="form-group">
				...
				<div class="modal fade" id="delete_overtime" role="dialog">
					<div class="modal-dialog modal-dialog-centered">
						<div class="modal-content">
							<div class="modal-body">
								<div class="form-header">
				...
				<!-- Add Deduction Modal -->
				<div id="add_deduction" class="modal fade" role="dialog">
					<div class="modal-dialog modal-dialog-centered" role="document">
						<div class="modal-content">
							<div class="modal-header">
							...
							<div class="modal-body">
								<form id="add_deduction_form" method="post" action="<?php echo base_url(); ?>employees/add_deduction/">
									<div class="form-group">
										<label>Name <span class="text-danger">*</span></label>
				...
				<div id="edit_deduction<?php echo $dec_ar['id']; ?>" class="modal fade" role="dialog">
					<div class="modal-dialog modal-dialog-centered" role="document">
						<div class="modal-content">
							<div class="modal-header">
							...
							<div class="modal-body">
								<form method="post" id="edit_deduction_form" action="<?php echo base_url(); ?>employees/edit_pfdeduction/<?php echo $dec_ar['id']; ?>">
									<div class="form-group">
										<label>Name <span class="text-danger">*</span></label>
				...
				<div class="modal fade" id="delete_deduction" role="dialog">
					<div class="modal-dialog modal-dialog-centered">
						<div class="modal-content">
							<div class="modal-body">
								<div class="form-header">
