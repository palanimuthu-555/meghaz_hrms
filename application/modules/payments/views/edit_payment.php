<div class="content">
	<div class="row">
		<div class="col-sm-4">
			<h4 class="page-title mb-2"><?=lang('edit_payment')?></h4>
		</div>
		...
		<div class="col-sm-12">
			<div class="card panel-white">
				<div class="card-header">
					<h3 class="card-title mb-0 p-2"><?=lang('payment_details')?> - TRANS <?=$i->trans_id?></h3>
				</div>
				<div class="card-body">
					<?php $attributes = array('class' => 'bs-example form-horizontal','id'=> 'paymentEditForm'); echo form_open(base_url().'payments/edit',$attributes); ?>
						...
						<div class="text-center submit-section">
							<button type="submit" class="btn btn-lg btn-primary submit-btn" id="payment_edit_submit"> <?=lang('save_changes')?></button>
						</div>
					</form>
				</div>
			</div>
