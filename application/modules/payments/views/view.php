<div class="content">
	<div class="row">
		...
		<div class="col-sm-6 col-6 text-right m-b-0">
			...
			<div class="card-box">
				...
				<ul class="list-group no-radius m-b-0">
					<li class="list-group-item">
						...
						<span class="float-right"><?=strftime(config_item('date_format')." %H:%M:%S", strtotime($i->created_date));?></span>
					</li>
					<li class="list-group-item">
						<span class="text-muted"><?=lang('transaction_id')?></span>
						<span class="float-right"><?=$i->trans_id?></span>
					</li>
					<li class="list-group-item">
					...
					<li class="list-group-item">
						...
						<span class="float-right"><?=App::get_method_by_id($i->payment_method)?></span>
					</li>
					<li class="list-group-item">
						<span class="text-muted"><?=lang('currency')?></span>
						<span class="float-right"><?=$i->currency?></span>
					</li>
					<li class="list-group-item">
						<span class="text-muted"><?=lang('notes')?></span>
						<span class="float-right"><?=($i->notes) ? $i->notes : 'NULL'; ?></span>
					</li>
...
<div class="">
	<div class="">
		<h3 class="card-title"><?=lang('payment_for')?></h3>
	</div>
	<div class="table-responsive">
		<table class="table table-striped custom-table m-b-0">
			...
			<tbody>
				<tr>
					<td>
						<a href="<?php if(App::is_permit('menu_invoices','read')){?><?=base_url()?>invoices/view/<?=$i->invoice?><?php }else{ echo '#';}?>
"><?=Invoice::view_by_id($i->invoice)->reference_no;?></a>
					</td>
					<td>
