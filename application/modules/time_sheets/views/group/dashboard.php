...
<div class="">
	...
	<div class="row">
		...
		<?php if (User::is_admin() || User::is_staff() || Project::setting('show_project_tasks', $project_id)) { ?>
            ...
            <div class="col-lg-6">
                <div class="card panel-white task-panel">
					<div class="card-header b-b">
						<div class="row">
							...
							<div class="col-6">
								<a href="<?= base_url() ?>projects/todo/add/<?= $project_id ?>" data-toggle="ajaxModal" class="btn btn-primary btn-xs float-right"><?= lang('create_list') ?></a>
							</div>
						</div>
					</div>
                    <div class="card-body">
