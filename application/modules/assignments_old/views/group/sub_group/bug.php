              ...
              <div class="row">
                <div class="col-lg-6">
                  <ul class="list-group no-radius m-b-0">
                    ...
                    <li class="list-group-item">
                      <span class="float-right"><strong><?=$i->issue_title?></strong></span><?=lang('issue_title')?>
                    </li>

                    <li class="list-group-item">
                      <span class="float-right"><strong><?=$i->issue_ref?></strong></span><?=lang('issue_ref')?>
                    </li>
                ...
                <div class="col-lg-6">
                  <ul class="list-group no-radius m-b-0">
                    <li class="list-group-item">
                      <span class="float-right"><strong><?=$i->severity?></strong></span><?=lang('severity')?>
                    </li>
                    <li class="list-group-item">
                      <span class="float-right"><strong><?=lang(strtolower($i->bug_status))?></strong></span><?=lang('bug_status')?>
                    </li>
                    <li class="list-group-item">
                      <span class="float-right"><strong><?=ucfirst($i->priority)?></strong> </span>
                      <?=lang('priority')?>
                    </li>


                    <li class="list-group-item">
                      <span class="float-right"><strong><?=strftime(config_item('date_format'), strtotime($i->reported_on));?></strong>
									...
									<li>
										...
										<?php  if($f->uploaded_by == User::get_id() || User::is_admin()){ ?>
                                            ...
                                            <ul class="files-action">
                                                <li class="dropdown">
                                                    <a href="" class="dropdown-toggle btn btn-default btn-sm" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-ellipsis-h"></i></a>
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item" href="<?=base_url()?>projects/bugs/file/edit/<?=$f->file_id?>/<?=$i->project?>" data-toggle="ajaxModal"><i class="fa fa-edit"></i> Edit</a>
                                                       <a class="dropdown-item" href="<?=base_url()?>projects/bugs/file/delete/<?=$f->file_id?>/<?=$i->project?>" data-toggle="ajaxModal"><i class="fa fa-edit"></i> Delete</a>
                                                    </div>
                                                </li>
                                            </ul>
											<?php } ?>
                ...
                <section class="comment-list block">
                      ...
                      <section class="card card-default">
                        ...
                        echo form_open(base_url().'projects/bugs/comment/',$attributes); ?>
                          ...
                          <footer class="card-footer bg-light lter">
                             <button class="btn btn-success float-right btn-sm" type="submit"><?=lang('post_comment')?></button>
                  ...
                  ?> 
                          <article class="comment-item">
                            <a class="float-left thumb-sm avatar">
                      <img src="<?php echo User::avatar_url($c->comment_by); ?>" class="rounded-circle">
                            </a>
                            <span class="arrow left"></span>
                            <section class="comment-body card card-default">
                              <header class="card-header bg-white">
                                <a href="#"><?=ucfirst(User::displayName($c->comment_by))?></a>
                                <label class="badge bg-<?=$role_label?> m-l-xs">
