                  ...
                  ?>
                      ...
                      <tr class="file-item">
                        ...
                        <a class="float-left thumb-sm avatar">
                          ...
                          <img src="<?php echo User::avatar_url($f->uploaded_by); ?>" class="rounded-circle" data-toggle="tooltip" data-title="<?php echo User::displayName($f->uploaded_by)?>" data-placement="top">
                        ...
                        <td class="text-right">
                          ...
                          <a class="btn btn-sm btn-danger" href="<?=base_url()?>projects/files/delete/<?=$f->project?>?group=files&id=<?=$f->file_id?>" data-toggle="ajaxModal"><i class="fa fa-trash-o"></i></a>

                          <a class="btn btn-sm btn-default" href="<?=base_url()?>projects/files/edit/<?=$f->project?>?group=files&id=<?=$f->file_id?>" data-toggle="ajaxModal"><i class="fa fa-edit"></i></a>
