...
<div class="content">
	<div class="row">
		...
		<div class="col-sm-8 col-9 text-right m-b-0">
			...
			<a href="<?=base_url()?>expenses/create" data-toggle="ajaxModal" title="<?=lang('create_expense')?>" class="btn btn-primary rounded float-right"><i class="fa fa-plus"></i> <?=lang('create_expense')?></a>
			<?php } ?>
		</div>
	</div>
				...
				<td class="text-right">
					<div class="dropdown">
						...
						<div class="dropdown-menu float-right">
								...
								<a class="dropdown-item" href="javascript:void(0)" onclick="accept_expense(<?=$e->id?>)" title="<?=lang('accept_expense')?>"><?=lang('approve')?></a>
							
								<a class="dropdown-item" href="javascript:void(0)" onclick="decline_expense(<?=$e->id?>)"><?=lang('reject')?></a>
							
							
								<a class="dropdown-item" href="<?=base_url()?>expenses/view/<?=$e->id?>"><?=lang('view_expense')?></a>
