	...
	<div class="modal-content">
		...
		<?php $attributes = array('class' => 'bs-example form-horizontal','id' => 'createExpenseForm'); echo form_open_multipart(base_url().'expenses/create',$attributes); ?>
			<div class="modal-body">
				<div class="form-group form-row">
					...
					<div class="col-lg-4">
						<select name="currency_symbol" class="form-control">
							...
							<option value="<?=$cur->symbol?> - <?=$cur->code?>" disabled <?=(config_item('default_currency') == $cur->code ? ' selected="selected"' : '')?>><?=$cur->symbol?> - <?=$cur->name?></option>
	                        <?php endforeach; ?>
	                    </select>
                    </div>
				</div>
				<div class="form-group">
					<label class="col-lg-12 control-label"><?=lang('notes')?> <span class="text-danger">*</span></label>
					<div class="col-lg-12">
						<textarea class="form-control ta" name="notes"></textarea>
					</div>
				</div>
				<div class="form-group">
					<label class="col-lg-12 control-label"><?=lang('project')?> <span class="text-danger">*</span></label>
					<div class="col-lg-12">
						<select name="project" class="form-control m-b" id="selected_project">
							...
							{?>
								<option value="<?php echo $p['project_id']?>"><?php echo $p['project_title']?></option>
							<?php
							}
							?> 
						</select>
				...
				<div class="form-group">
					<label class="col-lg-12 control-label"><?=lang('expense_date')?> <span class="text-danger">*</span></label>
					<div class="col-lg-12">
				...
				<div class="form-group">
					<label class="col-lg-12 control-label"><?=lang('category')?> <span class="text-danger">*</span></label>
					<div class="col-lg-12">
				...
				<div class="form-group">
					<label class="col-lg-12 control-label"><?=lang('billable')?></label>
					<div class="col-lg-12">
						<label class="switch">
				...
				<div class="form-group">
					<label class="col-lg-12 control-label"><?=lang('show_to_client')?></label>
					<div class="col-lg-12">
						<label class="switch">
				...
				<div class="form-group">
					<label class="col-lg-12 control-label"><?=lang('invoiced')?></label>
					<div class="col-lg-12">
						<label class="switch">
				...
				<div class="form-group position-relative">
					<label class="col-lg-12 control-label"><?=lang('attach_file')?></label>
					<div class="col-lg-12">
						<label class="btn btn-default btn-choose setting-choose-btn" style="left:20px">Choose File</label>
				...
				?>
					...
					<div class="row m-t-20">
						<label class="control-label col-lg-12">Message to Approvers</label>
						<div class="col-lg-12">														
