          ...
          <div class="row">
            <div class="col-12">
              ...
              <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Budget Statement</li>
                </ul>
            </div>
          </div>
        </div>
              ...
              <?php   $start_years = Date('Y', strtotime("-3 Year"));
                 $current_year = date("Y");
                    for ($i=$start_years; $i <=$current_year ; $i++) { ?>
                     <li class="nav-item <?php echo ($i == $current_year )?'active':'';?>"><a class="nav-link" data-toggle="tab" href="#statement_<?php echo $i;?>"><?php echo $i;?></a></li>
              <?php }?>
                ...
                <table class="table table-hover accounts-table budget-table m-b-0 table-nowrap">
                  ...
                  <tbody id="revenue_cont_<?php echo $i;?>">
                    <tr class="title-row">
                      ...
                      <?php if(App::is_permit('menu_budget_statement','create'))
					  {
					?>
					  <td class="text-right" colspan="5"><button type="button" class="btn btn-info btn-sm add-new" id="revenue_add" data-year ="<?php echo $i;?>" onclick="revenue_add(<?php echo $i;?>)"><i class="fa fa-plus"></i> Add Revenue</button></td>
                    <?php
					  }
					?>
					</tr>
                          ...
                          if(!empty($revenues)){
                            ...
                            foreach ($revenues as $revenue) {?>
                              <tr>
                                  ...
                                  <td data-name="oct" data-id="oct<?php echo $count.$i; ?>"><?php echo $revenue['oct'];?></td>
                                  ...
                                  <td class="text-right actionss">
                                    <a class="btn btn-info btn-sm add"  onclick="save_revenue(<?php echo $count?>,<?php echo $i?>,this)" data-type ="revenue" data-id ="<?php echo $revenue['id'];?>" id="revenue_save" title="Add" data-toggle="tooltip"><i class="fa fa-check"></i></a>
                                    <?php if(App::is_permit('menu_budget_statement','write')){?><a class="btn btn-success btn-sm edit" id="revenue_edit" title="Edit" data-toggle="tooltip"><i class="fa fa-pencil"></i></a><?php }?>
                                    <?php if(App::is_permit('menu_budget_statement','delete')){?><a class="btn btn-danger btn-sm delete" data-toggle="modal" data-target="#revenue_delete<?php echo $revenue['id']?>" id="" title="Delete" data-toggle="tooltip"><i class="fa fa-trash-o"></i></a><?php }?>
                                  </td>
                                <tr>
                  ...
                  <tbody id="expense_cont<?php echo $i;?>">
                    <tr class="title-row">
                      ...
                      <?php if(App::is_permit('menu_budget_statement','create'))
					  {?>
					  <td class="text-right" colspan="5"><button type="button" class="btn btn-info btn-sm add-new" id="expense_add" data-year ="<?php echo $i;?>" onclick="expense_add(<?php echo $i;?>)"><i class="fa fa-plus"></i> Add Expense</button></td>
                    <?php
					  }
					?>
					</tr>
                           ...
                           // $count = 0;
                            foreach ($expenses as $expense) {?>
                              <tr>
                                  ...
                                  <td class="text-right actionss">
							<a class="btn btn-info btn-sm add"  onclick="save_expense(<?php echo $expense_count?>,<?php echo $i?>,this)" data-type ="expense" data-id ="<?php echo $expense['id'];?>" id="expense_save" title="Add" data-toggle="tooltip"><i class="fa fa-check"></i></a><?php }?>
                                    <?php if(App::is_permit('menu_budget_statement','write')){?><a class="btn btn-success btn-sm edit" id="expense_edit" title="Edit" data-toggle="tooltip"><i class="fa fa-pencil"></i></a>
                                    <?php if(App::is_permit('menu_budget_statement','delete')){?><a class="btn btn-danger btn-sm delete" data-toggle="modal" data-target="#expense_delete<?php echo $expense['id']?>" id="" title="Delete" data-toggle="tooltip"><i class="fa fa-trash-o"></i></a><?php }?>
                                  </td>
                                <tr>
                  ...
                  <tbody id="tax_cont<?php echo $i;?>">
                    <tr class="title-row">
                      ...
                      <?php if(App::is_permit('menu_budget_statement','create'))
					  {?>
					  <td class="text-right" colspan="5"><button type="button" class="btn btn-info btn-sm add-new" id="" data-year ="<?php echo $i;?>" onclick="tax_add(<?php echo $i;?>)"><i class="fa fa-plus"></i> Add Tax</button></td>
                    <?php
					  }
					?>
					</tr>
                          ...
                          <?php   foreach ($taxes as $tax) {?>
                              <tr>
                                 ...
                                 <!--  <td data-name="feb" data-id="tax_feb<?php echo $tax_count.$i; ?>"></td>
                                  ...
                                  <td class="text-right actionss">
                                   <a class="btn btn-info btn-sm add"  onclick="save_tax(<?php echo $tax_count?>,<?php echo $i?>,this)" data-type ="tax" data-id ="<?php echo $tax['id'];?>" id="tax_save" title="Add" data-toggle="tooltip"><i class="fa fa-check"></i></a>
                                    <?php if(App::is_permit('menu_budget_statement','write')){?><a class="btn btn-success btn-sm edit" id="tax_edit" title="Edit" data-budget_name ="tax_budget_name<?php echo $tax_count.$i; ?>" data-tax="tax_percentage<?php echo $tax_count.$i; ?>" data-toggle="tooltip"><i class="fa fa-pencil"></i></a><?php }?>
                                    <?php if(App::is_permit('menu_budget_statement','delete')){?><a class="btn btn-danger btn-sm delete" data-toggle="modal" data-target="#tax_delete<?php echo $tax['id']?>" id="" title="Delete" data-toggle="tooltip"><i class="fa fa-trash-o"></i></a><?php }?>
                                  </td>
                                <tr>
