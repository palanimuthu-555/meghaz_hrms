...
Only one Performance module can be activated at a time.
								...
								<ul class="nav nav-tabs nav-tabs-bottom">
									<li class="nav-item <?php echo ('okr' == $active_performance )?'active':'';?>"><a class="active nav-link" href="#okr_tab" data-toggle="tab">OKRs</a></li>									
									<li class="nav-item <?php echo ('competency' == $active_performance )?'active':'';?>"><a  class="nav-link" href="#compentency_tab" data-toggle="tab">Competency-based</a></li>
									<!-- <li><a href="#kpi_tab" data-toggle="tab">KPI</a></li> -->
									<li class="nav-item <?php echo ('smart_goals' == $active_performance )?'active':'';?>"><a class="nav-link" href="#smart_goals_tab" data-toggle="tab">SMART Goals</a></li>
