    ...
    <div class="col-lg-12 p-0">
		...
		<div class="card panel-table">
			<div class="card-header">
				<h3 class="card-title mb-0"><?=lang('cron_jobs')?></h3>
			</div>
			<div class="card-body">
        ...
        echo form_open_multipart('settings/update', $attributes); ?>
            <div class="card panel-white">
                <div class="card-header font-bold">
					<h3 class="card-title p-5"><?=lang('cron_settings')?></h3>
				</div>
                <div class="card-body">
					...
					<div class="text-center m-t-30">
                        <button id="settings_cron_submit" class="btn btn-primary submit-btn"><?=lang('save_changes')?></button>
					</div>
                </div>
            </div>
        </form>
