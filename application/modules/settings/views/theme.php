		...
		echo form_open_multipart('settings/update', $attributes); ?>
			<div class="card panel-white">
				<div class="card-header">
					<h3 class="card-title p-5 mb-0"><?=lang('theme_settings')?></h3>
				</div>
				<div class="card-body">
					...
					<div class="form-group form-row">
						...
						<div class="col-lg-4">
							<label class="btn btn-default btn-choose setting-choose-btn">Choose File</label>
					...
					<div class="text-center m-t-30">
						<button id="settings_theme_submit" class="btn btn-primary submit-btn"><?=lang('save_changes')?></button>
					</div>
				</div>
			</div>
		</form>
