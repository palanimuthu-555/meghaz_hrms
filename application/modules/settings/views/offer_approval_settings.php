        ...
        <form action="<?php echo base_url(); ?>settings/offer_approval_settings" id="tokbox_form" class="bs-example form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">
            <div class="card panel-white">
                <div class="card-header">
                    <h3 class="card-title p-5">Offer Approval Settings</h3>
                </div>
                <div class="card-body">
                    ...
                    <div class="form-group  form-row row approver seq-approver" style="<?php echo ($default_offer_approval =='seq-approver')?"display: block;":"";?>">
                    ...
                    <div class="form-group row  form-row approver sim-approver" style="<?php echo ($sim_approve =='sim-approver')?"display: block;":"";?>">
                        <label class="control-label col-sm-3">Offer Approvers</label>
                        <div class="col-sm-9 ">
                    ...
                    <div class="text-center m-t-30 submit-section">
