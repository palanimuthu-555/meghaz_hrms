            ...
            <div class="col-lg-12 p-0">
               <div class="card card-white">
                  <div class="card-header">
                     <h3 class="card-title p-5">Approval Setting</h3>
                  </div>
                  <div class="card-body">
                    ...
                    <!-- <div class="form-group row approver sim-approver" style="<?php echo ($expense_sim_approve =='sim-approver')?"display: block;":"";?>">
                     ...
                     <div class="m-t-30">
                        ...
                        <div class="col-md-12 submit-section">
                          <button id="expense_approval_set_btn" type="submit" class="btn btn-primary btn-lgbtn btn-primary submit-btn">Save Changes</button>
                        </div>
                    </div>
        </form>
     <?php }?>
