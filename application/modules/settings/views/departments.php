    ...
    <div class="row">
        <div class="col-12">
            ...
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><?=lang('departments')?> & Designations</li>
            </ul>
        </div>
    </div>
        ...
        <div class="col-lg-12 row-eq-height">
            <div class="card panel-white panel-eq-dash">
                <div class="card-header">
                    <div class="row">
                        <div class="col-6">
                            <h3 class="card-title m-l-10"><?=lang('departments')?></h3>
                        </div>
                        <div class="col-6">
                            <a href="<?=base_url()?>all_departments/departments/" class="btn btn-xs btn-success float-right m-r-10" data-toggle="ajaxModal"><i class="fa fa-plus"></i> Add Department</a>
                        </div>
                    </div>
                </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    ...
                                    <a href="<?=base_url()?>settings/edit_dept/<?=$d->deptid?>" class="btn btn-success btn-sm" data-toggle="ajaxModal">
        ...
        <div class="col-lg-12 row-eq-height">
            <div class="card panel-white panel-eq-dash">
                <div class="card-header">
                    <div class="row">
                        <div class="col-6">
                            <h3 class="card-title m-l-10">Designations </h3>
                        </div>
                        <div class="col-6">
                            <a href="<?=base_url()?>all_departments/designations" class="btn btn-xs btn-success float-right m-r-10" data-toggle="ajaxModal"><i class="fa fa-plus"></i>Add Designation</a>
                        </div>
                    </div>
                    <div class="row">
