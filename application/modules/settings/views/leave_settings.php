						...
						<div class="leave-left">
							<div class="input-box">
								...
								<div class="leave-inline-form">
									...
									<?php $leave_carry = $this->db->get_where('common_leave_types',array('leave_id'=>2))->row_array(); ?></label>
										<input type="radio" name="carryfwd" class="CarryFwd form-check-input" value="no"  disabled="disabled" <?php if($leave_carry['leave_status']=='no'){ ?> checked <?php } ?>>No
									
								</div>
								<div class=" form-check form-check-inline">
									<label class="radio-inline form-check-label"></label>
										<input type="radio" name="carryfwd" class="CarryFwd form-check-input" value="yes" disabled="disabled" <?php if($leave_carry['leave_status']=='yes'){ ?> checked <?php } ?>>Yes
									</div>
									<div class="input-group mb-3" id="MaxDays" >
							...
							<div class="input-box">
								...
								<div class="leave-inline-form checkbox">
									...
									<?php $leave_weekend = $this->db->get_where('leave_weekend')->row_array();
									 ...
									 ?>
										<input class="mr-2" type="checkbox" name="days[]" class="weekend" value="saturday"  disabled="disabled" <?php echo (isset($weekend[0]) && $weekend[0] == 'saturday')?"checked":"";?>>Saturday
									</label>
									<label class="radio-inline">
										<input class="mr-2" type="checkbox" name="days[]" class="weekend" value="sunday" disabled="disabled" <?php echo (isset($weekend[1]) && $weekend[1] == 'sunday')?"checked":"";?> <?php echo (isset($weekend[0]) && $weekend[0] == 'sunday')?"checked":"";?>>Sunday
									</label>
...
<div id="new_leave_type" class="modal custom-modal fade" role="dialog">
...
<div id="delete_newpolicy" class="modal custom-modal fade" role="dialog">
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			<div class="modal-header">
