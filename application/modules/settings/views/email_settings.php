		...
		echo form_open('settings/update', $attributes); ?>
			<div class="card panel-white">
				<div class="card-header font-bold">
					<h3 class="card-title p-5"><?=lang('email_settings')?></h3>
				</div>
				<div class="card-body">
					...
					<div class="form-group form-row">
						...
						<div class="col-lg-4">
							<select name="protocol" class="form-control">
								...
								<option value="sendgrid"<?=($prot == "sendgrid" ? ' selected="selected"' : '')?>><?=lang('sendgrid')?></option>
							</select>
						</div>
					</div>
					<div class="form-group form-row">
						<label class="col-lg-3 control-label"><?=lang('sendgrid_key')?> <span class="text-danger">*</span></label>
						<div class="col-lg-4">
							<input type="text" class="form-control"  value="<?=config_item('sendgrid_key')?>" name="sendgrid_key">
						</div>
					</div>
					<div class="form-group form-row">
        ...
        echo form_open_multipart('settings/update', $attributes); ?>
            <div class="card panel-white">
                <div class="card-header">
					<h3 class="card-title"><?=lang('email_piping_settings')?></h3>
				</div>
                <div class="card-body">
                    <?php echo validation_errors(); ?>
                    <input type="hidden" name="settings" value="<?=$load_setting?>">
