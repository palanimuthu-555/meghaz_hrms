...
<div class="row">
        ...
        <div class="col-7 text-right m-b-30">
            <a href="<?=base_url()?>settings/lead_reporter_add" data-toggle="ajaxModal" class="btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Reporter</a>
        </div>
        <div class="col-7 text-right m-b-30">
        </div>
    </div>
        ...
        <table id="table-rates" class="table table-striped custom-table m-b-0 AppendDataTables">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-right">
                        <a class="btn btn-success btn-sm" href="<?=base_url()?>settings/lead_reporter_edit/<?php echo $leadreporter['reporter_id']; ?>" data-toggle="ajaxModal" title="<?=lang('edit_reporter')?>"><i class="fa fa-edit"></i></a>
                        <a class="btn btn-danger btn-sm" href="<?=base_url()?>settings/lead_reporter_delete/<?php echo $leadreporter['reporter_id']; ?>" data-toggle="ajaxModal" title="<?=lang('delete_reporter')?>"><i class="fa fa-trash-o"></i></a>
                    </td>
                </tr>
            <?php $i++; } ?>
            </tbody>
