        ...
        <div class="col-lg-12 p-0">
            <div class="card panel-white">
                <div class="card-header">
					<h3 class="card-title p-5"><?=lang('email_templates')?></h3>
				</div>
                <div class="card-body">
					<ul class="nav nav-tabs nav-tabs-solid m-b-20">
						...
						<li class="nav-item <?php if($setting_email == $temp){ echo "active"; } ?> ">
							<a class="nav-link" href="<?=base_url()?>settings/?settings=templates&group=<?=$template_group;?>&email=<?=$temp;?>"><?=lang($lang)?></a>
						</li>
					<?php endforeach; ?>
					</ul>
