    ...
    <div class="col-lg-12 p-0">
		<div class="card panel-table">
			<div class="card-header">
				<div class="row">
					<div class="col-6">
						<h3 class="card-title m-t-6"><?='Leave Types'?></h3>
					</div>
					<div class="col-6 text-right">
                    <a href="javascript:;" class="btn btn-sm btn-primary float-right" 
		...
		echo form_open_multipart('settings/leave_types', $attributes); ?>
			<div class="card leave_type_add_form" style="display:none">
				<div class="card-body">
