...
<div class="card card-white">
	<div class="card-header">
		<div class="row">
			<div class="col-6">
				<h3 class="card-title m-l-0 m-t-10"><?=lang('translations')?></h3>
			</div>
			<div class="col-6">
				<div class="float-right add-translation">
	...
	<div class="card-body">
		<div class="table-responsive">
			<table id="table-translations" class="table table-striped table-bordered custom-table m-b-0 AppendDataTables">
				<thead>
					<tr>
						<th class="col-1 no-sort"><?=lang('icon')?></th>
						<th><?=lang('language')?></th>
						<th><?=lang('progress')?></th>
						<th><?=lang('done')?></th>
						<th><?=lang('total')?></th>
				...
				<tbody>
					...
					?>
					<tr>
						<td class=""><img src="<?=base_url('assets/img/flags/'.$l->icon)?>.png" /></td>
...
<div class="card card-white">
	<div class="card-header">
		<h3 class="card-title"><?=lang('translations')?> - <?=ucwords($language)?></h3>
	</div>
	<div class="card-body">
		<div class="table-responsive">
			<table id="table-translations-files" class="table table-striped table-bordered custom-table m-b-0 AppendDataTables">
                <thead>
					<tr>
						<th class="col-2 no-sort"><?=lang('type')?></th>
						<th class="col-3"><?=lang('file')?></th>
						<th class="col-4"><?=lang('progress')?></th>
						<th class="col-1"><?=lang('done')?></th>
						<th class="col-1"><?=lang('total')?></th>
						<th class="col-options no-sort col-1 text-right"><?=lang('action')?></th>
					</tr>
                </thead>
                <tbody>
		...
		<div class="card-header">
			<div class="row">
				...
				<div class="col-6 text-right">
					<button type="submit" id="save-translation" class="btn btn-xs btn-primary float-right"><?=lang('save_translation')?></button>
				</div>
			</div>
		</div>
        <div class="card-body">
			<div class="table-responsive" style="white-space: pre-wrap;">
				<table id="table-strings" class="table table-striped table-bordered  m-b-0 AppendDataTables">
					<thead>
						<tr>
							<th class="">English</th>
							<th class=""><?=ucwords(str_replace("_"," ", $language))?></th>
						</tr>
					</thead>
					<tbody>
						<?php
						...
						<tr>
							<td><?=$value?></td>
							<td><input class="form-control" width="100%" style="min-width:200px" type="text" value="<?=(isset($translation[$key]) ? $translation[$key] : $value)?>" name="<?=$key?>" /></td>
						</tr>
						<?php endforeach; ?>
					</tbody>
				</table>
