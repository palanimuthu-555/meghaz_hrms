...
class Settings extends MX_Controller {
    ...
    function __construct()
    {
       ...
       // if(!User::is_admin()) redirect('');
		...
		if(!App::is_access('menu_settings'))
		{
    ...
    function _update_general_settings($setting){
        ...
        if ($this->form_validation->run() == FALSE)
        {
            ...
            // $this->session->set_flashdata('response_status', 'success');
            // $this->session->set_flashdata('message', lang('settings_updated_successfully'));
            $this->session->set_flashdata('tokbox_success', 'General Settings Updated Successfully');
            redirect('settings/'.$this->general_setting);
        }
    ...
    function _update_cron_settings(){
        ...
        if ($this->form_validation->run() == FALSE)
        {
            ...
            // $this->session->set_flashdata('response_status', 'success');
            // $this->session->set_flashdata('message', lang('settings_updated_successfully'));
            $this->session->set_flashdata('tokbox_success', 'Cron Settings Updated Successfully');
            redirect($_SERVER['HTTP_REFERER']);
        }
    }
    ...
    function project_settings(){
        ...
        // $this->session->set_flashdata('response_status', 'success');
        // $this->session->set_flashdata('message', lang('settings_updated_successfully'));
        $this->session->set_flashdata('tokbox_success', 'Project Settings Updated Successfully');
        redirect($_SERVER['HTTP_REFERER']);
    }
    ...
    function slack_conf(){
        ...
        $this->session->set_flashdata('tokbox_success', 'Slack Configuration Updated Successfully');
        // $this->session->set_flashdata('response_status', 'success');
        // $this->session->set_flashdata('message', lang('settings_updated_successfully'));
        redirect($_SERVER['HTTP_REFERER']);
    }
    ...
    function _update_system_settings($setting){
        ...
        $this->session->set_flashdata('tokbox_error', validation_errors());
            ...
            $this->session->set_flashdata('tokbox_success', 'System Settings Updated Successfully');
            // $this->session->set_flashdata('response_status', 'success');
            // $this->session->set_flashdata('message', lang('settings_updated_successfully'));
    ...
    function _update_theme_settings($setting){
        ...
        $this->session->set_flashdata('tokbox_success', 'Theme Settings Updated Successfully');
        // $this->session->set_flashdata('response_status', 'success');
        // $this->session->set_flashdata('message', lang('settings_updated_successfully'));
    ...
    function _update_invoice_settings($setting){
        ...
        if ($this->form_validation->run() == FALSE)
        {
            ...
            $this->session->set_flashdata('tokbox_success', 'Invoice Settings Updated Successfully');
            // $this->session->set_flashdata('response_status', 'success');
            // $this->session->set_flashdata('message', lang('settings_updated_successfully'));
            redirect($_SERVER['HTTP_REFERER']);
        }
    ...
    function _update_estimate_settings($setting){
        ...
        if ($this->form_validation->run() == FALSE)
        {
            ...
            // $this->session->set_flashdata('response_status', 'success');
            // $this->session->set_flashdata('message', lang('settings_updated_successfully'));
            $this->session->set_flashdata('tokbox_success', 'Estimate Settings Updated Successfully');
            redirect($_SERVER['HTTP_REFERER']);
        }
    ...
    function _update_email_settings(){
        ...
        if ($this->form_validation->run() == FALSE)
        {
            ...
            if (isset($_POST['smtp_pass']))
            {
                ...
                $smtp_pass = base64_encode($raw_smtp_pass);// $this->encrypt->encode($raw_smtp_pass);
            ...
            if (isset($_POST['mail_password']))
            {
                ...
                $mail_pass = base64_encode($raw_mail_pass);//$this->encrypt->encode($raw_mail_pass);
            ...
            $this->session->set_flashdata('tokbox_success', 'Email Settings Updated Successfully');
            // $this->session->set_flashdata('response_status', 'success');
            // $this->session->set_flashdata('message', lang('settings_updated_successfully'));
            redirect($_SERVER['HTTP_REFERER']);
        }
    ...
    function _update_salary_settings(){
        ...
        if ($this->input->post()) {
            ...
            $this->session->set_flashdata('tokbox_error', validation_errors());
                ...
                // $this->session->set_flashdata('response_status', 'success');
                // $this->session->set_flashdata('message', lang('settings_updated_successfully'));
                $this->session->set_flashdata('tokbox_success', 'Salary Settings Updated Successfully');
    ...
    function _update_payment_settings(){
        if ($this->input->post()) {
            ...
            $this->session->set_flashdata('tokbox_error', lang('settings_update_failed'));
                ...
                // $this->session->set_flashdata('response_status', 'success');
                // $this->session->set_flashdata('message', lang('settings_updated_successfully'));
                $this->session->set_flashdata('tokbox_success', 'Payment Settings Updated Successfully');
                redirect($_SERVER['HTTP_REFERER']);
            }
        }else{
            // $this->session->set_flashdata('response_status', 'error');
    ...
    function update_email_templates(){
        if ($this->input->post()) {
            ...
            $this->session->set_flashdata('tokbox_error', lang('settings_update_failed'));
                ...
                // $this->session->set_flashdata('response_status', 'success');
                // $this->session->set_flashdata('message', lang('settings_updated_successfully'));
                $this->session->set_flashdata('tokbox_success', 'Email Template Updated Successfully');
    ...
    {
		$enable_action=$this->input->post('action');
		
        switch ($action) {
            case $enable_action:
                $role = $this->input->post('access');
                $status = $this->input->post('status');
				return $this->db->where('module',$item)->where('access',$role)->update('hooks', array($enable_action => $status));
    ...
    function leave_types(){
        if ($this->input->post()) {
            ...
            $this->session->set_flashdata('tokbox_success', 'Leave Type Updated Successfully');
            } 
    ...
    function tokbox_settings()
    {
        ...
        $this->session->set_flashdata('tokbox_success', 'TokBox Settings Updated Successfully');
...
//load excel file
            ...
            foreach ($objPHPExcel->getWorksheetIterator() as $sheet)
            {
                ...
                for($j=2; $j<=$lastRow; $j++)
                {
                    ...
                    $email = $objWorksheet->getCellByColumnAndRow(2,$j)->getValue();
