  ...
  <div class="float-right">
           <?=$this->load->view('report_header');?>
            ...
            <?php if($this->uri->segment(3) && count($projects)> 0 ){ ?>
              <a href="<?=base_url()?>reports/projectpdf/<?=$project->project_id;?>/<?=$status?>" class="btn btn-primary float-right ml-2"><i class="fa fa-file-pdf-o m-r-5"></i><?=lang('pdf')?>
              </a>
            <?php } ?>
            </div>
</div>
...
<div class="col-md-4">
  <div class="form-group select-focus form-focus">
          ...
          <select class="select2-option form-control floating" name="project_title" >
        ...
        <tr class="<?php if (Project::timer_status('project',$p->project_id) == 'On') { echo "text-danger"; } ?>">
          ...
          <td>
           ...
           <!--  <?php if (Project::timer_status('project',$p->project_id) == 'On') { ?>
            ...
            echo '<span class="label label-'.$color.' float-right">';
