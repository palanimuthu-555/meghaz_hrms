...
<div class="page-header">
					<div class="row">
						...
						<div class="col-md-6">
							...
							<h4 class="page-title">Invoicebyclient</h4>
							<ul class="breadcrumb">
	...
	<div class="col-md-6 float-right">
		<div class="float-right">
			...
			<a href="<?=base_url()?>reports/invoicespdf/<?=$customer->co_id;?>" class="btn btn-primary float-right">
		...
		<div class="col-md-12">
			...
			<div class="fill body reports-top rep-new-band">
					...
					<div class="criteria-band p-0">
						...
						<div class="row">
								...
								<div class="col-md-4">
									...
									<select class="select2-option form-control floating" style="width:100%" name="client" >
								...
								<div class="col-md-2">  
									<button class="btn btn-success mt-0" type="submit"><?=lang('run_report')?></button>
								</div>
							</form>
						</div>
					</div>
				...
				<div class="rep-container">
					...
					<table class="table zi-table table-hover norow-action custom-table table-striped">
						<thead>
							<tr>
								<th class="text-left">
