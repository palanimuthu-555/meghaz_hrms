    ...
    <div class="page-header">
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <h4 class="page-title">Expensesbyclient</h4>
              <ul class="breadcrumb">
  ...
  <div class="float-right">
           <?=$this->load->view('report_header');?>
            ...
            <?php if($this->uri->segment(3) && isset($customer->co_id)){ ?>
              <a href="<?=base_url()?>reports/expensespdf/<?=$customer->co_id;?>/<?=$report_by?>" class="btn btn-primary float-right ml-2"><i class="fa fa-file-pdf-o m-r-5"></i><?=lang('pdf')?>
              </a>
            <?php } ?>
            </div>
</div>
  ...
  <div class="criteria-band p-0">
    ...
    <div class="col-md-3">
       <div class="form-group select-focus form-focus">
          ...
          <select class="form-control select floating" name="report_by">
...
<div class="col-md-4">
   <div class="form-group select-focus form-focus">
    ...
    <span></span> <b class="caret"></b> -->
          <select class="select2-option form-control floating" name="client" >
...
<th class="text-left">
  ...
  <div class="float-left over-flow"> <?=lang('billable')?></div>
</th>
         <th class="sortable text-left">
  <div class="float-left over-flow"> <?=lang('category')?></div>
<!----></div>
</th>
