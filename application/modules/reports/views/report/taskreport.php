     ...
     <div class="page-header">
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <h4 class="page-title">Tasks Report</h4>
              <ul class="breadcrumb">
 ...
 <div class="col-md-6">
  <div class="float-right">
            ...
            <?php if($this->uri->segment(3) && count($tasks)> 0 ){ ?>
              <a href="<?=base_url()?>reports/taskpdf/<?=$task_id;?>/<?=$task_progress?>" class="btn btn-primary float-right ml-2"><i class="fa fa-file-pdf-o m-r-5"></i><?=lang('pdf')?>
              </a>              
            <?php } ?>
          ...
          <div class="criteria-band p-0">
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                ...
                <select class="select2-option form-control floating" style="width:280px" name="task_id" >
              ...
              <div class="col-md-2">
                ...
                <select class="form-control floating" name="task_progress">
