...
<div class="content">
 ...
 <div class="col-md-6">
  <div class="float-right">
            ...
            <?php if($this->uri->segment(3) && count($users)> 0 ){ ?>
              <a href="<?=base_url()?>reports/userpdf/<?=$role_id;?>" class="btn btn-primary float-right ml-2"><i class="fa fa-file-pdf-o m-r-5"></i><?=lang('pdf')?>
              </a>              
            <?php } ?>
 ...
 <div class="form-group form-focus select-focus">
                <label class="control-label"><?=lang('user_role')?> </label>
                <select class="select2-option form-control  floating" name="role_id" >
