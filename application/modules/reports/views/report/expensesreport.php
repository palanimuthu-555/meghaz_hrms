  ...
  <div class="float-right">
         <?=$this->load->view('report_header');?>
            ...
            <?php if($this->uri->segment(3)){ ?>
              <a href="<?=base_url()?>reports/expensespdf/<?=strtotime($start_date)?>/<?=strtotime($end_date)?>/<?=$report_by?>" class="btn btn-primary float-right ml-2"><i class="fa fa-file-pdf-o m-r-5"></i><?=lang('pdf')?>
              </a>
            <?php } ?>
            </div>
</div>
