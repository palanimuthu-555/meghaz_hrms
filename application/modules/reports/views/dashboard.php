...
<div class="content">
	...
	<div class="row">
		<div class="col-sm-4">
			<div class="card card-info m-b-2">
				<div class="card-body">
					<div class="clear">
						<span class="text-dark"><?=lang('total_sales')?></span>
						<small class="block text-danger float-right m-l bt">
			...
			<div class="card card-info m-b-2">
				<div class="card-body">
					<div class="clear">
						...
						<small class="block text-danger float-right m-l">
							<strong>
			...
			<div class="card card-info m-b-2">
				<div class="card-body">
					<div class="clear">
						...
						<small class="block text-muted float-right m-l">
			...
			<div class="card card-info">
				<div class="card-body">
					<div class="clear">
						...
						<small class="block text-muted float-right m-l"><?=Report::num_payments()?></small>
					</div>
				</div>
			</div>
		</div>
		<div class="col-md-8">
			<div class="card">
				<div class="card-header">
					<h3 class="card-title mb-0"><?=lang('invoiced_monthly')?></h3>
				</div>
	...
	<div class="row">
		...
		<div class="col-md-3 col-sm-6">
			<div class="card">
				<div class="card-header">
					<h3 class="card-title">1st <?=lang('quarter')?>, <?=$chart_year?></h3>
				</div>
				<div class="card-body">
					<?php
					...
					?>
					<div class="clearfix m-b-md text-muted"><?=lang('cal_january')?><div class="float-right ">
					<?=Applib::format_currency($cur->code,$total_jan);?></div>
					</div>
					<div class="clearfix m-b-md text-muted"><?=lang('cal_february')?><div class="float-right ">
					<?=Applib::format_currency($cur->code,$total_feb);?>
					</div>
					</div>
					<div class="clearfix m-b-md text-muted"><?=lang('cal_march')?><div class="float-right ">
		...
		<div class="col-md-3 col-sm-6">
			<div class="card">
				<div class="card-header">
					<h3 class="card-title">2nd <?=lang('quarter')?>, <?=$chart_year?></h3>
				</div>
				<div class="card-body">
					<?php
					...
					?>
					<div class="clearfix m-b-md text-muted"><?=lang('cal_april')?><div class="float-right">
					<?=Applib::format_currency($cur->code,$total_apr);?></div>
					</div>
					<div class="clearfix m-b-md text-muted"><?=lang('cal_may')?><div class="float-right">
					<?=Applib::format_currency($cur->code,$total_may);?>
					</div>
					</div>
					<div class="clearfix m-b-md text-muted"><?=lang('cal_june')?><div class="float-right">
		...
		<div class="col-md-3 col-sm-6">
			<div class="card">
				<div class="card-header">
					<h3 class="card-title">3rd <?=lang('quarter')?>, <?=$chart_year?></h3>
				</div>
				<div class="card-body">
					<?php
					...
					?>
					<div class="clearfix m-b-md text-muted"><?=lang('cal_july')?><div class="float-right">
					<?=Applib::format_currency($cur->code,$total_jul);?></div>
					</div>
					<div class="clearfix m-b-md text-muted"><?=lang('cal_august')?><div class="float-right">
					<?=Applib::format_currency($cur->code,$total_aug);?>
					</div>
					</div>
					<div class="clearfix m-b-md text-muted"><?=lang('cal_september')?><div class="float-right">
		...
		<div class="col-md-3 col-sm-6">
			<div class="card">
				<div class="card-header">
					<h3 class="card-title">4th <?=lang('quarter')?>, <?=$chart_year?></h3>
				</div>
				<div class="card-body">
					<?php
					...
					?>
					<div class="clearfix m-b-md text-muted"><?=lang('cal_october')?><div class="float-right">
						<?=Applib::format_currency($cur->code,$total_oct);?></div>
					</div>
					<div class="clearfix m-b-md text-muted"><?=lang('cal_november')?>
					<div class="float-right">
						<?=Applib::format_currency($cur->code,$total_nov);?>
					</div>
					</div>
					<div class="clearfix m-b-md text-muted"><?=lang('cal_december')?>
					<div class="float-right">
				...
				<div class="slim-scroll" data-height="400" data-disable-fade-out="true" data-distance="0" data-size="5px" data-color="#333333">
					<ul class="list-group alt">
						...
						<li class="list-group-item">
							<div>
							<a href="<?php if(App::is_permit('menu_tickets','read')){?><?php } else { echo'#';}?>"><?=Client::view_by_id($client->co_id)->company_name?></a>
			...
			<div class="card-box">
				...
				<div class="slim-scroll" data-height="400" data-disable-fade-out="true" data-distance="0" data-size="5px" data-color="#333333">
					<ul class="list-group alt">
						...
						<li class="list-group-item">
							<div>
								<a href="<?php if(App::is_permit('menu_invoices','read')){?><?=base_url()?>invoices/view/<?=$i->inv_id?><?php } else { echo'#';}?>"><?=$i->reference_no;?></a>
								<small class="text-muted float-right">
			...
			<div class="card-box">
				...
				<div class="slim-scroll" data-height="400" data-disable-fade-out="true" data-distance="0" data-size="5px" data-color="#333333">
					<ul class="list-group alt">
						...
						<li class="list-group-item">
							<div>
								<a href="<?php if(App::is_permit('menu_clients','read')){?><?=base_url()?>companies/view/<?=$e->client?><?php } else { echo'#';}?>"><?=$client->company_name?></a>
								<small class="text-muted float-right">
