											...
											<td>
												<div class="tabbable">
													<ul class="nav navbar-nav wizard flex-row m-b-0">
														...
														<li class="active nav-item">
															<a class="nav-link" href="<?php echo base_url(); ?>offers/offer_view/<?php echo $ipv['id']; ?>" ><span class="nmbr"><i class="fa fa-check" aria-hidden="true"></i></span>In Progress</a>
														</li>
														<li class=" nav-item">
											...
											<td>
												<div class="tabbable">
													<ul class="nav navbar-nav flex-row wizard m-b-0">
														...
														<li class="active nav-item">
															<a class="nav-link" href="<?php echo base_url(); ?>offers/offer_view/<?php echo $rv['id']; ?>" ><span class="nmbr"><i class="fa fa-check" aria-hidden="true"></i></span>Offer Approved</a>
														</li>
											...
											<td>
												<div class="tabbable">
													<ul class="nav navbar-nav flex-row wizard m-b-0">
														...
														<li class="active nav-item">
															<a class="nav-link" href="<?php echo base_url(); ?>offers/offer_view/<?=$ipv['id'];?>" ><span class="nmbr"><i class="fa fa-check" aria-hidden="true"></i></span>Send Offer</a>
														</li>
														<li>
											...
											<td>
												<div class="tabbable">
													<ul class="nav navbar-nav flex-row wizard m-b-0">
														...
														<li class="active nav-item">
															<a class="nav-link" href="<?php echo base_url(); ?>offers/offer_view/<?=$ipv['id'];?>" ><span class="nmbr"><i class="fa fa-check" aria-hidden="true"></i></span>Offer Accepted</a>
														</li>
														<li class=" nav-item">
															<a class="nav-link" href="javascript:void(0)" ><span class="nmbr"><i class="fa fa-check" aria-hidden="true"></i></span>Onboard</a>
														</li>
												...
												<div class="tabbable">
													<ul class="nav navbar-nav flex-row wizard m-b-0">
														...
														<li class="offer-declined nav-item">
															<a class="nav-link" href="<?php echo base_url(); ?>offers/offer_view/<?=$ipv['offer_id'];?>" ><span class="nmbr"><i class="fa fa-check" aria-hidden="true"></i></span>Offer Declined</a>
														</li>
														<li class="nav-item">
															<a class="nav-link" href="javascript:void(0)" ><span class="nmbr"><i class="fa fa-check" aria-hidden="true"></i></span>Onboard</a>
														</li>
											...
											<td>
												<div class="tabbable">
													<ul class="nav navbar-nav flex-row wizard m-b-0">
														...
														<li class="active nav-item">
															<a class="nav-link" href="<?php echo base_url(); ?>offers/offer_view/<?=$ipv['id'];?>" ><span class="nmbr"><i class="fa fa-check" aria-hidden="true"></i></span>Offer Archived</a>
														</li>
														<li>
															<a class="nav-link" href="javascript:void(0)" ><span class="nmbr"><i class="fa fa-check" aria-hidden="true"></i></span>Onboard</a>
														</li>
