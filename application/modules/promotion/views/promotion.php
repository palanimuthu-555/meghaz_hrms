                ...
                <li class="breadcrumb-item active">Promotion</li>
						...
						<div class="col-sm-7 col-7 text-right m-b-30">
							<?php
							if(App::is_permit('menu_promotion','create'))
							{
							?>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="table-responsive">
									...
									<table class="table table-striped custom-table mb-0" id="promotion_table">
										<thead>
											<tr>
												...
												<?php if(App::is_permit('menu_promotion','write')==true || App::is_permit('menu_promotion','delete')==true)
												{
												?>
