    ...
    <div class="modal-content">
		...
		<?php $attributes = array('id' => 'editClientForm'); echo form_open(base_url().'companies/update',$attributes); ?>
			...
			<div class="modal-body">
				<ul class="nav nav-tabs nav-tabs-solid" id="tabsUptClient" role="tablist">
					<li class="nav-item"><a class="active nav-link" data-toggle="tab" id="tab_upt_client_general" href="#tab-client-general"><?=lang('general')?></a></li>
					<li class="nav-item"><a class="nav-link" data-toggle="tab" id="tab_upt_client_contact" href="#tab-client-contact"><?=lang('contact')?></a></li>
					<li class="nav-item"><a class="nav-link" data-toggle="tab" id="tab_upt_client_web" href="#tab-client-web"><?=lang('web')?></a></li>
					<li class="nav-item"><a class="nav-link" data-toggle="tab" id="tab_upt_client_bank" href="#tab-client-bank"><?=lang('bank')?></a></li>
					<li class="nav-item"><a class="nav-link" data-toggle="tab" id="tab_upt_client_hosting" href="#tab-client-hosting"><?=lang('hosting')?></a></li>
