    ...
    <div class="modal-content">
        <div class="modal-header">
			...
			<h4 class="modal-title">
				<?=lang('new_company')?> - <span class="badge badge-default"><?=$company_ref?></span>
			</h4>
        </div>
		<?php $attributes = array('id' => 'createClientForm'); echo form_open(base_url().'companies/create', $attributes); ?>
			<div class="modal-body">
				<ul class="nav nav-tabs nav-tabs-solid" id="tabsClient" role="tablist">
					<li class="nav-item"><a class="active nav-link" data-toggle="tab" id="tab_client_general" href="#tab-client-general"><?=lang('general')?></a></li>
					<li class="nav-item"><a class="nav-link" data-toggle="tab" id="tab_client_contact" href="#tab-client-contact"><?=lang('contact')?></a></li>
					<li class="nav-item"><a class="nav-link" data-toggle="tab" id="tab_client_web" href="#tab-client-web"><?=lang('web')?></a></li>
					<li class="nav-item"><a class="nav-link" data-toggle="tab" id="tab_client_bank" href="#tab-client-bank"><?=lang('bank')?></a></li>
					<li class="nav-item"><a class="nav-link" data-toggle="tab" id="tab_client_hosting" href="#tab-client-hosting"><?=lang('hosting')?></a></li>
