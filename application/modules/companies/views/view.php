						...
						<div class="row user-tabs">
							<div class="col-lg-12 col-md-12 col-sm-12 line-tabs">
								<ul class="nav nav-tabs nav-tabs-bottom">
									<li class="nav-item"><a class="active nav-link active" data-toggle="tab" href="#myprojects">My Projects</a></li>
									<li class="nav-item <?=($tab == 'contacts') ? 'active' : '';?>">
										<a class="nav-link" data-toggle="tab" href="#mycontacts"><?=lang('contacts')?></a>
									</li>
									<li class="nav-item <?=($tab == 'invoices') ? 'active' : '';?>">
										<a class="nav-link" data-toggle="tab" href="#myinvoices"><?=lang('invoices')?></a>
									</li>
									<li class="nav-item <?=($tab == 'estimates') ? 'active' : '';?>">
										<a class="nav-link" data-toggle="tab" href="#myestimates"><?=lang('estimates')?></a>
									</li>
									<li class="nav-item <?=($tab == 'files') ? 'active' : '';?>">
										<a class="nav-link" data-toggle="tab" href="#myfiles"><?=lang('files')?></a>
									</li>
								</ul>
							</div>
						</div>
							...
							<div class="tab-content profile-tab-content">
								...
								<div id="mycontacts" class="tab-pane fade">
									...
									<div class="row">
									    <div class="col-md-12">
													...
													<div class="row">
														<div class="col-6">
															<h3 class="card-title m-t-6"><?=lang('contacts')?></h3>
														</div>
														<div class="col-6">
															<a href="<?=base_url()?>contacts/add/<?=$i->co_id?>" class="btn btn-success float-right" data-toggle="ajaxModal"><i class="fa fa-plus"></i> <?=lang('add_contact')?></a>
														</div>
													</div>
												
											
												<div class="table-responsive">
													<table id="table-client-details-12" class="table table-striped custom-table m-b-0 AppendDataTables">
														<thead>
															<tr>
														...
														<?php 
															...
															$client_list=Client::get_client_contacts($i->co_id);
															
														foreach ($client_list as $key => $contact) { 
															...
															<tr>
																<td>
																	<h2 class="table-avatar">
																		...
																		<img src="<?php echo User::avatar_url($contact->user_id);?>" class="thumb-sm rounded-circle" width='30'height='30'></a>
																		<a href="javascript::void(0)"><?php echo User::displayName($contact->user_id);?> </a>
																...
																<td><?=$login_time?> </td>
																<td class="text-right">
																	<a href="<?=base_url()?>companies/send_invoice/<?=$contact->user_id?>/<?=$i->co_id?>" class="btn btn-primary btn-sm" title="<?=lang('email_invoice')?>" data-toggle="ajaxModal">
																		<i class="fa fa-envelope"></i> </a>
																	<a href="<?=base_url()?>companies/make_primary/<?=$contact->user_id?>/<?=$i->co_id?>" class="btn btn-default btn-sm" title="<?=lang('primary_contact')?>" >
								...
								<div id="myinvoices" class="tab-pane fade">
									...
									<div class="col-md-12">
											...
											<div class=" panel-h-p1">
												<h3 class="card-title m-t-5 m-b-20"><?=lang('invoices')?></h3>
											</div>
									...
									<div class="row">
									    <div class="col-md-12">
									            ...
									            <div class=" panel-h-p1">
													<div class="row">
														<div class="col-6">
															<h3 class="card-title m-t-6"><?=lang('estimates')?></h3>
														</div>
														<div class="col-6">
															<a href="<?=base_url()?>estimates/add/<?=$i->co_id?>" class="btn btn-success float-right" data-toggle="ajaxModal"><i class="fa fa-plus"></i> <?=lang('estimates')?></a>
														</div>
													</div>
												</div>
										...
										<div class="col-md-12">
											<div class="files-panel">
												<div class=" panel-h-p1">
													<div class="row">
														<div class="col-6">
															<h3 class="card-title m-t-6"><?=lang('files')?></h3>
														</div>
														<div class="col-6">
															<a href="<?=base_url()?>companies/file/add/<?=$i->co_id?>" class="btn btn-success btn-sm float-right" data-toggle="ajaxModal" data-placement="left" title="<?=lang('upload_file')?>"><i class="fa fa-plus-circle"></i> <?=lang('upload_file')?></a>	
														</div>
													</div>
												</div>
