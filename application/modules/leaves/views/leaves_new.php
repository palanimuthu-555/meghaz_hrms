...
<div class="card-box">
	...
	<!-- user leaves -->
		<div class="row filter-row">
			...
			<div class="col-sm-8 col-md-8 col-12 col-lg-4 search_date">
				<div class="row">
			...
			<div class="col-sm-4 col-md-4 col-6 col-lg-2">
	   ...
	   ?>
			 <table id="table-holidays" class="table table-striped custom-table m-b-0 AppendDataTables">
				...
				<tbody id="admin_leave_tbl">
					...
					<tr>
						...
						<?php
						if($levs['status'] == 4){
								echo '<span class="badge badge-info"> Approved</span><br>';
		...
		<div class="card panel-white new_leave_reqst" style="display:none">
	...
	<?php } ?>
	<div class="card panel-table" id="team_leaves">
						  ...
						  foreach($leave_list as $key => $levs){  
						  	if($check_teamlead['is_teamlead'] == 'yes'){
								...
								if($check_teamlead['is_teamlead'] == 'no'){
										...
										if($check_teamlead['is_teamlead'] == 'yes')
										echo '<span class="badge text-white" style="background:#D2691E"> Requested </span>';
									}else if($levs['status'] == 1){
										echo '<span class="badge badge-success"> Approved </span> ';
									}else if($levs['status'] == 2){
										echo '<span class="badge badge-danger"> Rejected</span>';
