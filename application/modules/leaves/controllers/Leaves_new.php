 		...
 		$leave_list = $this->db->query($qry)->result_array();
  	    foreach($leave_list as $key => $levs){   
				 $html    .= '<tr>
				   ...
				   $html    .= '</td>
								<td>';
									if($levs['status'] == 0){ $html    .= '<span class="badge" style="background:#D2691E"> Pending </span>';
									}else if($levs['status'] == 1){ $html    .= '<span class="badge badge-success"> Approved </span>';
									}else if($levs['status'] == 2){ $html    .= '<span class="badge badge-danger"> Rejected</span>';
									}else if($levs['status'] == 3){ $html    .= '<span class="badge badge-danger"> Cancelled</span>'; } 
				   $html    .= '</td>
								<td>';
				   if($levs['status'] == 0){
