	...
	<div class="modal-content">
		...
		<div class="modal-body">
			 ...
			 <div class="form-group form-row">
				<label class="col-lg-12 control-label"><?=lang('full_name')?> <span class="text-danger">*</span></label>
				<div class="col-lg-12">
				...
				<div class="form-group form-row">
                                <label class="col-lg-12 control-label"><?=lang('company')?> <span class="text-danger">*</span></label>
                                <div class="col-lg-12">
			      ...
			      <div class="form-group form-row">
			        <label class="col-lg-12 control-label"><?=lang('department')?> <span class="text-danger">*</span></label>
			        <div class="col-lg-12">
		...
		<option value="<?=$d->deptid?>" <?=($d->deptid == $info->department || (is_array($dep) && in_array($d->deptid, $dep))) ? ' selected="selected"' : ''?>>
			   ...
			   <?php if (User::get_role($user->id) != 'client') { ?>
			    ...
			    <div class="form-group form-row">
				<label class="col-lg-12 control-label"><?=lang('hourly_rate')?> <span class="text-danger">*</span></label>
				<div class="col-lg-12">
				...
				<div class="form-group form-row">
				<label class="col-lg-12 control-label"><?=lang('phone')?> <span class="text-danger">*</span></label>
				<div class="col-lg-12">
				...
				<div class="form-group form-row">
				<label class="col-lg-12 control-label"><?=lang('mobile_phone')?> <span class="text-danger">*</span></label>
				<div class="col-lg-12">
					<input type="text" class="form-control" value="<?=$info->mobile?>" name="mobile">
				</div>
                                </div>
				<div class="form-group form-row">
				<label class="col-lg-12 control-label">Skype</label>
				<div class="col-lg-12">
		...
		<div class="modal-footer submit-section mt-0"> <a href="#" class="btn btn-danger submit-btn" data-dismiss="modal"><?=lang('close')?></a>
		<button class="btn btn-success submit-btn" id="update_exist_user"><?=lang('save_changes')?></button>
		</form>
		</div>
	</div>
	<!-- /.modal-content -->
