	...
	<div class="row">
		...
		<div class="col-md-4 col-5">
			...
			<ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><?=lang('all_users')?></li>
            </ul>
		</div>
...
<?php
		...
		<div class="col-md-8 col-7 text-right m-b-30">

			<?php
			if(App::is_permit('menu_users','create'))
			{
			?>
			<a href="javascript:void(0)" class="btn add-btn float-right m-l-5" data-toggle="modal" data-target="#add_new_user"><i class="fa fa-plus"></i> <?=lang('new_user')?></a>
			<?php
			}
			?>
					...
					<div class="row filter-row">
						<div class="col-sm-3 col-6">  
							<div class="form-group form-focus">
								...
								<input type="text" class="form-control floating users_search_submit" id="username" name="username">
				...
				<div class="modal-body m-b-0">
					...
					echo form_open(base_url().'auth/register_user',$attributes); ?>
						...
						<div class="row">
							...
							{?>
								<option value="<?php echo $c['co_id']?>"><?php echo $c['company_name']?></option>
							<?php
							}
							?> 
									</select>
			...
			<div class="modal-content">
				...
				<div class="modal-body m-b-30">
						...
						<form method="post" id="paypal_form">
							...
							<div class="m-t-20 text-center submit-section">
								<a href="javascript:void(0);" id="user_subscripe" class="btn btn-primary submit-btn">Subscribe</a>
								<button id="paypal_subscription"  class="btn btn-primary submit-btn" style="display: none;">Subscribe </button>
							</div>
					</form>
						</div>
				</div>
