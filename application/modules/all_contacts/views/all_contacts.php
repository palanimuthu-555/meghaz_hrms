                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="navbar justify-content-end">
                                            ...
                                            <!-- <div class="message-search m-t-0 d-inline-block float-right">
                                            ...
                                            <div class="search-box m-t-0">
                                                 ...
                                                 <!-- <ul class="nav navbar-nav float-right chat-menu mt-0">
                                                <li class="dropdown">
                                                    <a href="" class="mr-0" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-cog"></i></a>
                                        ...
                                        <div class="contact-box clearfix row">
                                            <div class="contact-cat col-sm-4 col-lg-3">
                                               <!-- <a href="javascript:void(0);" class="btn btn-primary btn-block" data-toggle="modal" data-target="#add_contact"><i class="fa fa-plus"></i> Add Contact</a>--->
												...
												{
												?>
											   <a class="btn btn-primary btn-block" href="<?=base_url();?>all_contacts/create_contacts/"  data-toggle="ajaxModal" ><i class="fa fa-plus"></i> Add Contact</a>
												<?php
												}
												?>
