...
class All_contacts extends MX_Controller
{
    public function __construct()
    {
		...
		// echo App::is_access('all_contacts');
		// exit();
    ...
    public function create_contacts()
    {
        ...
        if ($this->input->post()) {
               ...
               // echo "<pre>"; print_r( $_POST); exit;
                ...
                //                             <a href="" class="action-icon" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
                //                             <div class="dropdown-menu">
                //                                 <a class="dropdown-item" href="'.base_url().'all_contacts/edit_contact/'.$contact['id'].'"  data-toggle="ajaxModal" >Edit</a>
                //                                 <a class="dropdown-item" href="'.base_url().'all_contacts/delete_contact/'.$contact['id'].'" data-toggle="ajaxModal" >Delete</a>
                //                             </div>
                //                         </li>
                //                     </ul>
                //                 </div>
