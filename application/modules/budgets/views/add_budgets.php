						...
						<form method="post" id="add_budget_form" action="<?php echo base_url(); ?>budgets/add_budgets">
							...
							<div class="form-group">
								<div class="form-check form-check-inline">
								  <input class="form-check-input BudgetType" type="radio" name="budget_type" id="project" value="project" required>
								  <label class="form-check-label" for="project">Project</label>
								</div>
								<div class="form-check form-check-inline">
								  <input class="form-check-input BudgetType" type="radio" name="budget_type" id="category" value="category" required>
								  <label class="form-check-label" for="category">Category</label>
								</div>
							<!--	<label class="radio-inline mr-2">
							      <input type="radio" name="budget_type" class="BudgetType mr-2" value="project">Project
							    </label>
							    <label class="radio-inline">
							      <input type="radio" name="budget_type" class="BudgetType mr-2" value="category">Category
							    </label>-->
							</div>
