						...
						<form method="post" action="<?php echo base_url(); ?>budgets/edit_budgets/<?php echo $budgets['budget_id']; ?>">
							...
							<div class="form-group">
								<div class="form-check form-check-inline">
								  <input class="form-check-input" type="radio" name="budget_type" id="project1" value="project" <?php if($budgets['budget_type'] == 'project'){ echo 'checked'; } ?> >
								  <label class="form-check-label" for="project1">Project</label>
								</div>
								<div class="form-check form-check-inline">
								  <input class="form-check-input" type="radio" name="budget_type" id="category1" value="category" <?php if($budgets['budget_type'] == 'category'){ echo 'checked'; } ?>>
