...
?>
												...
												<tr>
													...
													<td class="text-center">
														...
														<button style="min-width:70px;padding:10px;" class="btn btn-warning" type="button" 
														 name="progress[]"><?php if($obj->progress_value != '') { ?><?php echo $obj->progress_value?>%<?php } else {?>0%<?php } ?>
														</button>
		...
		<?php $okr_objectives = $this->db->select()
			...
			foreach ($okr_objectives as $okr_objective) { 
				...
				?>
				<div id="add_obj_feedback<?php echo $okr_objective['id']?>" class="modal fade" role="dialog">
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form class=""  action="<?=base_url()?>performance/objective_feedback" method="POST">
	...
	<!-- /Add result Feedback Modal -->
		<?php $okr_results = $this->db->select()
			...
			foreach ($okr_results as $okr_result) { ?>
				<div id="add_result_feedback<?php echo $okr_result['id']?>" class="modal fade" role="dialog">
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal">&times;</button>
