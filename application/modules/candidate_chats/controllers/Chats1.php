 					 ...
 					 $html .= '<div class="chat" id="c_wind_'.$val['id'].'" c_lst="'.$val['id'].'">
									<div class="chat-avatar">
										<a class="avatar" href="javascript:void(0);">
											<img class="img-fluid img-circle" src="'.$prf_img2.'" alt="">
										</a>
									</div>
				 ...
				 if($val['text_from'] != $sess_id){
					 ...
					 if(config_item('use_gravatar') == 'TRUE' AND 
 					 ...
 					 $html .= '<div class="chat chat-left" id="c_wind_'.$val['id'].'" c_lst="'.$val['id'].'">
									<div class="chat-avatar">
										<a class="avatar" href="javascript:void(0);">
											<img class="img-fluid img-circle" src="'.$prf_img3.'" alt="">
										</a>
									</div>
									<div class="chat-body2">
										<div class="chat-content2">
	   ...
	   $login_user                = $qry->result_array(); 
	    ...
	    if(config_item('use_gravatar') == 'TRUE' AND 
  	   ...
  	   $html1 = '<div class="chat" id="c_wind2_'.$last_id.'" c_lst2="'.$last_id.'">
					<div class="chat-avatar">
						<a class="avatar">
							<img alt="" src="'.$prf_img.'" class="img-fluid img-circle">
						</a>
					</div>
					<div class="chat-body">
	   ...
	   $login_user                 = $qry->result_array(); 
	    ...
	    if(config_item('use_gravatar') == 'TRUE' AND 
  	   ...
  	   $html1 = '<div class="chat" id="c_wind2_'.$last_id.'" c_lst2="'.$last_id.'">
					<div class="chat-avatar">
						<a class="avatar" >
							<img class="img-fluid img-circle" src="'.$prf_img.'" alt="">
						</a>
					</div>
					<div class="chat-body">
						<div class="chat-content">
			...
			$html .= '</span>
			   ...
			   $html .= '</span>';			  
						  if($hist_det[0]['new_chats']  > 0){  
							  $html .= '<b class="badge bg-warning float-right" id="new_chat_cnt_'.$user_id.'">'.$hist_det[0]['new_chats'].'</b>';
						  } 
		    $html .= '</p>
					</div>
			 </li>'; 
  			 ...
  			 foreach($chat_det as $key => $val){
 				 ...
 				 if($val['text_from'] != $sess_id){
					...
					$html .= '<div class="chat chat-left" id="c_wind2_'.$val['id'].'" c_lst2="'.$val['id'].'">
									<div class="chat-avatar">
										<a class="avatar">
											<img alt="" src="'.$prf_img3.'" class="img-fluid img-circle">
										</a>
									</div>
									<div class="chat-body">
										<div class="chat-content">
