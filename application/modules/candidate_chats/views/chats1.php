...
<div class="chat-main-wrapper">
	...
	<div class="col-3 profile-right chat-profile-view">
				...
				<li class="" chat_id="<?=$chat_hist->user_id?>" onClick="email_list_active(this);chat_details(<?=$chat_hist->user_id?>);">
					...
					<div class="chat-user">
						...
						<?php 
						 ...
						 <img width="35" src="<?=$this->applib->get_gravatar($user_email)?>" class="rounded-circle">
						 ...
						 <img width="35" src="<?=base_url()?>assets/avatar/<?=$img_prf?>" class="rounded-circle">
					...
					<div class="chat-user-info chat_usr_<?=$chat_hist->user_id?>">
						...
						<p class="msg-text"> 
							...
							if($chat_hist->new_chats > 0){  
							   ...
							   echo '<b class="badge bg-warning float-right" id="new_chat_cnt_'.$chat_hist->user_id.'">'.$chat_hist->new_chats.'</b>';

							}else{

							   echo '<b class="badge bg-warning float-right" style="display:none" id="new_chat_cnt_'.$chat_hist->user_id.'"> 0 </b>';
	...
	<div class="col-9 message-view" id="email-list">
