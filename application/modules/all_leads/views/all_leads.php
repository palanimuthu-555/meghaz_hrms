									...
									<tbody>
										...
										<tr>
											...
											<td class="table-avatar">
												<a href="#" class="avatar"><img src="<?php echo User::avatar_url($leads['user_id']); ?>" class="rounded-circle" data-toggle="tooltip" data-title="<?=User::displayName($p->assign_lead); ?>" data-placement="top"></a>
												<a href="<?php if(App::is_permit('menu_users','read')){?><?php echo base_url(); ?>employees/profile_view/<?php echo $leads['user_id']; ?><?php }else{ echo '#';}?>"><?php echo $leads['fullname']; ?></a>
											</td>
											...
											<td>
												...
												if(count($check_lead_projects) != 0){
													...
													<a href="<?php if(App::is_permit('menu_projects','read')){?><?php echo base_url(); ?>projects/view/<?php echo $ch_projects['project_id']; ?><?php }else{ echo '#';}?>"><?php echo $ch_projects['project_title']; ?></a><br>
												<?php 
												} 
												}
												else{ ?>
