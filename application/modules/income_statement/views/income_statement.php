          ...
          <div class="budget-tabs">           
            ...
            <?php   $start_years = Date('Y', strtotime("-3 Year"));
                 $current_year = date("Y");
                    ...
                    <li class="nav-item <?php echo ($i == $current_year )?'active':'';?>" id="tab_<?php echo $i;?>"><a class="nav-link" data-toggle="tab" class="statement" data-year="<?php echo $i;?>" href="#statement_<?php echo $i;?>"><?php echo $i;?></a></li>
                  <?php }?>
            </ul>
          </div>
