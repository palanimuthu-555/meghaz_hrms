...
<head>
	...
	<?php if (isset($editor)) { ?>
	<link href="<?=base_url()?>assets/css/plugins/summernote-bs4.css" rel="stylesheet">
	<?php } ?>
	...
	<!-- <link rel="stylesheet" href="<?=base_url()?>assets/plugins/dataTables.bootstrap.min.css"> -->
...
<body class="theme-<?=config_item('top_bar_color')?>">
	...
	<?php if ($this->uri->segment(2) == '' || $this->uri->segment(2) == 'calendar') { ?>
